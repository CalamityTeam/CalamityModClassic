        ...
        public override void AI()
        {
			...
			if (flag15 && Main.myPlayer == Projectile.owner)
			{
				...
				if (flag16)
				{
					...
					Projectile.NewProjectile(Entity.GetSource_FromThis(null), vector3.X, vector3.Y, vector2.X, vector2.Y, Mod.Find<ModProjectile>("DaemonsFlameArrow").Type, weaponDamage2, weaponKnockback2, Projectile.owner, 0.0f, speedY);
				}
				else
				{
					Projectile.Kill();
