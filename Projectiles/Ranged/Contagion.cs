			...
			if (Projectile.type == Mod.Find<ModProjectile>("Contagion").Type)
			{
				...
				if (flag && Main.myPlayer == Projectile.owner)
				{
					...
					if (flag2)
					{
						...
						Projectile.NewProjectile(Entity.GetSource_FromThis(null), value2.X, value2.Y, spinningpoint.X, spinningpoint.Y, num6, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
					}
					else
					{
						Projectile.Kill();
