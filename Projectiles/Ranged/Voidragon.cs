...
namespace CalamityModClassicPreTrailer.Projectiles.Ranged
{
    public class Voidragon : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
        	...
        	{
        		Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("PlasmaExplosion").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 1f);
        	}
