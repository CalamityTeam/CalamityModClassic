...
namespace CalamityModClassicPreTrailer.Projectiles.Ranged
{
    public class ExoMark : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (Projectile.localAI[1] < 30f) 
			{
				for (int num1134 = 0; num1134 < 1; num1134++) 
				{
					...
					Dust dust34 = Main.dust[Dust.NewDust(position4, 0, 0, 107, 0f, 0f, 0, default(Color), 0.5f)];
			...
			{
				Projectile.NewProjectile(Projectile.GetSource_FromThis(null), Projectile.Center, Vector2.Zero, Mod.Find<ModProjectile>("ExoTornado").Type, Projectile.damage, 2f, Projectile.owner, 1f, 0f);
			}
        ...
        public override bool PreDraw(ref Color lightColor)
        {
			...
			Microsoft.Xna.Framework.Color color47 = Main.hslToRgb(0f, 3f, 0f).MultiplyRGBA(new Microsoft.Xna.Framework.Color(255, 255, 255, 0));
