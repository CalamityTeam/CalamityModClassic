    ...
    public class Nuke : ModProjectile
    {
        ...
        public override void AI()
        {
        	...
        	if (flarePowderTimer <= 0)
        	{
        		...
        		{
        			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("DragonDust").Type, (int)((double)Projectile.damage * 0.5), Projectile.knockBack, Projectile.owner, 0f, 0f);
        		}
        		flarePowderTimer = 12;
        	}
