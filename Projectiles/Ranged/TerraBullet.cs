		...
		public override void AI()
		{
        	...
        	if (Projectile.localAI[0] >= 6f)
        	{
				...
				for (int num136 = 0; num136 < 3; num136++)
				{
					...
					int num137 = Dust.NewDust(new Vector2(x2, y2), 1, 1, 74, 0f, 0f, 0, default(Color), 0.5f);
		...
		public override void OnKill(int timeLeft)
        {
        	if (Projectile.owner == Main.myPlayer)
        	{
				for (int num252 = 0; num252 < 2; num252++)
				{
					...
					Projectile.NewProjectile(Projectile.GetSource_FromThis(null), Projectile.oldPosition.X + (float)(Projectile.width / 2), Projectile.oldPosition.Y + (float)(Projectile.height / 2), value15.X, value15.Y, Mod.Find<ModProjectile>("TerraBulletSplit").Type, (int)((double)Projectile.damage * 0.3), 0f, Projectile.owner, 0f, 0f);
				}
        	}
