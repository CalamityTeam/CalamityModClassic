...
namespace CalamityModClassicPreTrailer.Projectiles.Ranged
{
    public class MiniRocket : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
        	...
        	{
        		Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("MiniRocketExplosion").Type, Projectile.damage, 0f, Projectile.owner, 0f, 0f);
        	}
