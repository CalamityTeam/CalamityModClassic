    ...
    public class TyphoonBubble : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
			...
			if (Projectile.owner == Main.myPlayer)
			{
				...
				{
					int num230 = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X - (float)(Projectile.direction * 30), Projectile.Center.Y - 4f, (float)(-(float)Projectile.direction) * 0.01f, 0f, Mod.Find<ModProjectile>("WaterSpout").Type, Projectile.damage, 3f, Projectile.owner, 16f, 8f);
