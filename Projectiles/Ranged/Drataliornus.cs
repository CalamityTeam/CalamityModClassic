        ...
        public override void AI() //mostly phangasm code
        {
            ...
            if (timeToFire && Main.myPlayer == Projectile.owner)
            {
                if (canFire) //fire an angery flame
                {
                    ...
                    type = Mod.Find<ModProjectile>("DrataliornusFlame").Type;
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(null), position, speed, type, damage, knockBack, Projectile.owner, ai0, 0f);
