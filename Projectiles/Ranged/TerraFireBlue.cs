...
{
    public class TerraFireBlue : ModProjectile
    {
        ...
        {
        	Lighting.AddLight(Projectile.Center, ((255 - Projectile.alpha) * 0.05f) / 255f, ((255 - Projectile.alpha) * 0.15f) / 255f, ((255 - Projectile.alpha) * 0.45f) / 255f);
        ...
        {
        	target.AddBuff(Mod.Find<ModBuff>("GlacialState").Type, 240);
