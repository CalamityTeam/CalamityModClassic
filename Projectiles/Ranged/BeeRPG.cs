        	...
        	if (Projectile.owner == Main.myPlayer)
			{
				...
				for (int num517 = 0; num517 < num516; num517++)
				{
					if (num517 % 2 != 1 || Main.rand.Next(3) == 0)
					{
						...
						int num520 = Projectile.NewProjectile(Entity.GetSource_FromThis(null), value20.X, value20.Y, num518, num519, Main.player[Projectile.owner].beeType(), Main.player[Projectile.owner].beeDamage(Projectile.damage / 4), Main.player[Projectile.owner].beeKB(0f), Main.myPlayer, 0f, 0f);
