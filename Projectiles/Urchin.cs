    ...
    public class Urchin : ModProjectile
    {
        ...
        public override void AI()
        {
        	...
        	if (dust >= 0)
        	{
				...
				{
					int num503 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y + 16f), Projectile.width, Projectile.height - 16, DustID.BubbleBurst_Purple, 0f, 0f, 0, default(Color), 1f);
        	...
        	if (Projectile.owner == Main.myPlayer)
			{
				...
				if (flag18)
				{
					...
					for (int num252 = 0; num252 < num251; num252++)
					{
						...
						int spore = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X - 4f, Projectile.Center.Y, value15.X, value15.Y, Mod.Find<ModProjectile>("UrchinSpike").Type, (int)((double)5 * player.GetDamage(DamageClass.Summon).Multiplicative), 1f, Projectile.owner, 0f, 0f);
