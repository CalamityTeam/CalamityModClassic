    ...
    public class BigFlare : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
			...
			if (Projectile.owner == Main.myPlayer)
			{
				...
				int num235 = Main.expertMode ? 310 : 500;
				int num236 = Projectile.NewProjectile(Projectile.GetSource_FromThis(), (float)(num232 * 16 + 8), (float)(num231 * 16 - 24), 0f, 0f, Mod.Find<ModProjectile>("Infernado").Type, num235, 4f, Main.myPlayer, 16f, 16f + (revenge ? 4f : 0f));
