...
namespace CalamityModClassic1Point2.Projectiles
{
    public class ElementalAxeR : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
            	Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.GemRuby, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f);
            }
