...
namespace CalamityModClassic1Point2.Projectiles
{
    public class ChaosGeyser : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			int num199 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Flare, 0f, 0f, 100, default(Color), 1f);
			...
			{
				int num200 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Flare, 0f, 0f, 100, default(Color), 1f);
