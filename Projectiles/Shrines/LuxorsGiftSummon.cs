		...
		public override void AI()
		{
			if (dust > 0)
			{
				...
				for (int num227 = 0; num227 < num226; num227++)
				{
					...
					int num228 = Dust.NewDust(vector6 + vector7, 0, 0, 107, vector7.X * 1.75f, vector7.Y * 1.75f, 100, default(Color), 1.1f);
			...
			float num635 = 2200f;
			float num636 = 150f;
			bool flag64 = Projectile.type == Mod.Find<ModProjectile>("LuxorsGiftSummon").Type;
			...
			{
				bool flag23 = (Main.projectile[num638].type == Mod.Find<ModProjectile>("LuxorsGiftSummon").Type);
