...
namespace CalamityModClassicPreTrailer.Projectiles.Shrines
{
	public class UnstableSpark : ModProjectile
	{
		...
		public override void AI()
		{
			...
			int num199 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 206, 0f, 0f, 100, default(Color), 0.5f);
			...
			{
				int num200 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 206, 0f, 0f, 100, default(Color), 0.5f);
