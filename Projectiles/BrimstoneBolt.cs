...
namespace CalamityModClassic1Point2.Projectiles
{
    public class BrimstoneBolt : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			{
				Dust dust4 = Main.dust[Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.LifeDrain, Projectile.velocity.X, Projectile.velocity.Y, 100, default(Color), 1f)];
