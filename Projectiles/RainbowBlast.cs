...
namespace CalamityModClassic1Point1.Projectiles
{
    public class RainbowBlast : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Rainbow Blast");
            Projectile.width = 10;
        ...
        public override void OnKill(int timeLeft)
        {
            for (int k = 0; k < 5; k++)
            {
            	int dust = Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, 27, 0f, 0f, 100, new Color(Main.DiscoR, Main.DiscoG, Main.DiscoB));
