...
namespace CalamityModClassic1Point1.Projectiles
{
    public class SupremeDustProjectile : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Supreme Dust");
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("SupremeDustFlakProjectile").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
