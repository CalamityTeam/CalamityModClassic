...
namespace CalamityModClassic1Point2.Projectiles
{
    public class InfernalBlade : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (Projectile.alpha > 0)
			{
				...
				while ((float)num99 < num98)
				{
					...
					int num100 = Dust.NewDust(Projectile.Center, 0, 0, DustID.TheDestroyer, 0f, 0f, 0, default(Color), 1f);
        ...
        public override void OnKill(int timeLeft)
        {
			...
			{
				int num489 = Dust.NewDust(Projectile.Center, 0, 0, DustID.TheDestroyer, 0f, 0f, 100, default(Color), 1f);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
    		...
    		{
    			Projectile.NewProjectile(Projectile.GetSource_FromThis(), vector2.X, vector2.Y, speedX, speedY, Mod.Find<ModProjectile>("InfernalBlade2").Type, (int)((double)Projectile.damage * 0.75f), 1f, Projectile.owner);
    		}
