...
namespace CalamityModClassic1Point1.Projectiles
{
    public class Calamitamini : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Calamitamini");
            Projectile.width = 40;
        ...
        public override void AI()
        {
			...
			float num635 = 0f;
			float num636 = 0f;
			if (Projectile.type == Mod.Find<ModProjectile>("Calamitamini").Type)
			{
				num633 = 700f;
				num634 = 800f;
				num635 = 1200f;
			...
			bool flag64 = Projectile.type == Mod.Find<ModProjectile>("Calamitamini").Type;
			...
			{
				bool flag23 = (Main.projectile[num638].type == Mod.Find<ModProjectile>("Calamitamini").Type);
			...
			bool flag25 = false;
			if (Projectile.ai[0] != 1f && (Projectile.type == Mod.Find<ModProjectile>("Calamitamini").Type))
			{
				Projectile.tileCollide = false;
			}
			...
			if ((Projectile.type == Mod.Find<ModProjectile>("Calamitamini").Type) && flag25 && Projectile.ai[0] == 0f)
			{
			...
			else
			{
				...
				if (!flag26)
				{
					flag26 = (Projectile.ai[0] == 1f && (Projectile.type == Mod.Find<ModProjectile>("Calamitamini").Type));
				}
				float num650 = 6f;
				if (flag26)
				{
			...
			if (Projectile.ai[1] > 0f && (Projectile.type == Mod.Find<ModProjectile>("Calamitamini").Type))
			{
				Projectile.ai[1] += (float)Main.rand.Next(1, 4);
			}
			if (Projectile.ai[1] > 90f && (Projectile.type == Mod.Find<ModProjectile>("Calamitamini").Type))
			{
				Projectile.ai[1] = 0f;
				Projectile.netUpdate = true;
			}
			if (Projectile.ai[0] == 0f && (Projectile.type == Mod.Find<ModProjectile>("Calamitamini").Type))
			{
				if (Projectile.type == Mod.Find<ModProjectile>("Calamitamini").Type)
				{
					float scaleFactor3 = 8f;
					int num658 = Mod.Find<ModProjectile>("BrimstoneLaserSummon").Type;
