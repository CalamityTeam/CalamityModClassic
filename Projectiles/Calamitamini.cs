        ...
        public override void AI()
        {
        	if (Projectile.localAI[0] == 0f)
        	{
				...
				for (int num227 = 0; num227 < num226; num227++)
				{
					...
					int num228 = Dust.NewDust(vector6 + vector7, 0, 0, DustID.LifeDrain, vector7.X * 1.75f, vector7.Y * 1.75f, 100, default(Color), 1.1f);
			...
			player.AddBuff(Mod.Find<ModBuff>("CalamitasEyes").Type, 3600);
			if (flag64)
			{
				if (player.dead)
				{
