	...
	public class UrchinBall : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Projectile.ai[0] == 1f || Projectile.ai[0] == 2f)
			{
				...
				{
					spike = false;
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X, Projectile.velocity.Y, Mod.Find<ModProjectile>("UrchinBallSpike").Type, (int)((double)Projectile.damage * 0.5), 0f, Main.myPlayer, 0f, 0f);
				}
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Texture2D texture2D2 = ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/ExtraTextures/Chains/UrchinFlailChain").Value;
