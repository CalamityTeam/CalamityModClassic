...
namespace CalamityModClassic1Point1.Projectiles
{
    public class DrewsSandyWaifu : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Drew's Waifu");
        ...
        public override void AI()
        {
			...
			float num635 = 0f;
			float num636 = 0f;
			if (Projectile.type == Mod.Find<ModProjectile>("DrewsSandyWaifu").Type)
			{
				num633 = 700f;
				num634 = 800f;
				num635 = 1200f;
			...
			bool flag24 = false;
			if (Projectile.ai[0] == 2f && Projectile.type == Mod.Find<ModProjectile>("DrewsSandyWaifu").Type)
			{
				Projectile.ai[1] += 1f;
			...
			bool flag25 = false;
			if (Projectile.ai[0] != 1f && (Projectile.type == Mod.Find<ModProjectile>("DrewsSandyWaifu").Type))
			{
				Projectile.tileCollide = false;
			}
			...
			if (Projectile.type == Mod.Find<ModProjectile>("DrewsSandyWaifu").Type && flag25 && Projectile.ai[0] == 0f)
			{
			...
			else
			{
				...
				if (!flag26)
				{
					flag26 = (Projectile.ai[0] == 1f && (Projectile.type == Mod.Find<ModProjectile>("DrewsSandyWaifu").Type));
				}
				float num650 = 6f;
				if (flag26)
				{
			...
			if (Projectile.ai[1] > 0f && (Projectile.type == Mod.Find<ModProjectile>("DrewsSandyWaifu").Type))
			{
				Projectile.ai[1] += (float)Main.rand.Next(1, 4);
			}
			if (Projectile.ai[1] > 40f && Projectile.type == Mod.Find<ModProjectile>("DrewsSandyWaifu").Type)
			{
				Projectile.ai[1] = 0f;
				Projectile.netUpdate = true;
			}
			if (Projectile.ai[0] == 0f && (Projectile.type == Mod.Find<ModProjectile>("DrewsSandyWaifu").Type))
			{
				if (Projectile.type == Mod.Find<ModProjectile>("DrewsSandyWaifu").Type && Projectile.ai[1] == 0f && flag25 && num633 < 500f)
				{
					Projectile.ai[1] += 1f;
