    ...
    public class SolarPixie : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (Projectile.localAI[0] == 0f)
        	{
				...
				{
					int num503 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y + 16f), Projectile.width, Projectile.height - 16, DustID.CopperCoin, 0f, 0f, 0, default(Color), 1f);
			...
			if (Projectile.owner == Main.myPlayer)
			{
				...
				if (flag11)
				{
					...
					num404 *= num406;
					num405 *= num406;
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X - 4f, Projectile.Center.Y, num404, num405, 260, 6, Projectile.knockBack, Projectile.owner, 0f, 0f);
					Projectile.ai[0] = 50f;
					return;
				}
			}
