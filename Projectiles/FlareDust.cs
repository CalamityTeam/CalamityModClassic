...
namespace CalamityModClassic1Point1.Projectiles
{
    public class FlareDust : ModProjectile
    {
        ...
        {
        	bool lol = Main.expertMode;
        	int damage = lol ? 80 : 130;
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("FlareExplosionHuge").Type, damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
