...
namespace CalamityModClassic1Point1.Projectiles
{
    public class SkyFlare : ModProjectile
    {
        ...
        public override void AI()
        {
        	...
        	Projectile.velocity.Y *= 0.9975f;
        	int addStuff = Main.rand.Next(4);
        	blowTimer += addStuff;
        	if (blowTimer >= 900)
        	{
        		Projectile.Kill();
        ...
        {
        	int projectileExp = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("GoliathExplosion").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        	Main.projectile[projectileExp].friendly = false;
        	Main.projectile[projectileExp].hostile = true;
