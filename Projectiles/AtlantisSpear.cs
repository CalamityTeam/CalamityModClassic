...
namespace CalamityModClassic1Point1.Projectiles
{
    public class AtlantisSpear : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Atlantis Spear");
            Projectile.width = 52;
        ...
        public override void AI()
        {
        	...
        	if (Projectile.ai[0] == 0f)
			{
        		...
        		if (Projectile.alpha <= 0)
				{
					...
					if (Main.myPlayer == Projectile.owner)
					{
						...
						{
							num48 = Mod.Find<ModProjectile>("AtlantisSpear2").Type;
						}
        	...
        	else
			{
				if (Projectile.alpha < 170 && Projectile.alpha + 5 >= 170)
				{
					...
					{
						int num56 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 206, Projectile.velocity.X * 0.005f, Projectile.velocity.Y * 0.005f, 200, default(Color), 1f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < numProj; i++)
            {
                ...
                int projectile2 = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, perturbedSpeed.X, perturbedSpeed.Y, Mod.Find<ModProjectile>("AtlantisSpear2").Type, (int)((double)Projectile.damage), Projectile.knockBack, Projectile.owner, 0f, 0f);
