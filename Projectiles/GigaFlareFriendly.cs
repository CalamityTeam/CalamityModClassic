...
{
    public class GigaFlareFriendly : ModProjectile
    {
    	
        public override void SetDefaults()
        {
            //Tooltip.SetDefault("Giga Flare");
            Projectile.width = 20;
        ...
        public override void OnKill(int timeLeft)
        {
			...
			for (i = 0; i < 2; i++ )
			{
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, (float)( Math.Sin(offsetAngle) * 5f ), (float)( Math.Cos(offsetAngle) * 5f ), Mod.Find<ModProjectile>("PhoenixFireFriendly").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, (float)( -Math.Sin(offsetAngle) * 5f ), (float)( -Math.Cos(offsetAngle) * 5f ), Mod.Find<ModProjectile>("PhoenixFireFriendly").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
			}
