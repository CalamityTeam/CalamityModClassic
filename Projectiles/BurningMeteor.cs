    ...
    public class BurningMeteor : ModProjectile
    {
        ...
        public override void AI()
		{
			...
			if (Projectile.ai[1] == 1f)
			{
				...
				{
					Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.CopperCoin, Projectile.velocity.X * 1.5f, Projectile.velocity.Y * 1.5f, 150, default(Color), 2f);
					return;
				}
			}
