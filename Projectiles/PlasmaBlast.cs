...
namespace CalamityModClassic1Point1.Projectiles
{
    public class PlasmaBlast : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Plasma Blast");
            Projectile.width = 26;
        ...
        public override void AI()
		{
			...
			if (Main.rand.Next(16) == 0)
			{
				...
				int num59 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, Mod.Find<ModDust>("MSparkle").Type, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, 150, default(Color), 1.2f);
			...
			if (Projectile.ai[1] == 1f)
			{
				...
				{
					Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, Mod.Find<ModDust>("MSparkle").Type, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, 150, default(Color), 1.2f);
				}
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int k = 0; k < 5; k++)
            {
            	Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, Mod.Find<ModDust>("MSparkle").Type, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f);
            }
        }
    }
}