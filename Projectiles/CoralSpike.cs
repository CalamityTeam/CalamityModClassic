...
namespace CalamityModClassic1Point1.Projectiles
{
    public class CoralSpike : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Coral Spike");
            Projectile.width = 14;
        ...
        public override void AI()
        {
        	...
        	int num199 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 102, 0f, 0f, 100, default(Color), 1f);
			...
			{
				int num200 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 102, 0f, 0f, 100, default(Color), 1f);
