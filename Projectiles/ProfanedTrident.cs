...
namespace CalamityModClassic1Point2.Projectiles
{
    public class ProfanedTrident : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
			...
			{
				int num622 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.CopperCoin, 0f, 0f, 100, default(Color), 1.2f);
			...
			{
				int num624 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.CopperCoin, 0f, 0f, 100, default(Color), 1.7f);
