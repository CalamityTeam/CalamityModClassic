			...
			else
			{
				...
				if (Projectile.ai[0] > 8f)
				{
					...
					if (Projectile.owner == Main.myPlayer)
					{
						...
						Projectile.NewProjectile(Projectile.GetSource_FromThis(), (float)num414, (float)num415, 0f, 5f, Mod.Find<ModProjectile>("Shaderain").Type, Projectile.damage, 0f, Projectile.owner, 0f, 0f);
					}
				}
			}
