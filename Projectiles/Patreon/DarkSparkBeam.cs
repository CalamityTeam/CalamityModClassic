...
namespace CalamityModClassicPreTrailer.Projectiles.Patreon
{
    public class DarkSparkBeam : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (Projectile.type != Mod.Find<ModProjectile>("DarkSparkBeam").Type || !Main.projectile[(int)Projectile.ai[1]].active || Main.projectile[(int)Projectile.ai[1]].type != Mod.Find<ModProjectile>("DarkSpark").Type)
			{
				Projectile.Kill();
				return;
			}
