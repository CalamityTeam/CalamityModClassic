    ...
    public class SandTornado : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
			...
			Projectile.localNPCHitCooldown = 15 -
        		...
        		(CalamityWorld1Point2.downedDoG ? 3 : 0) -
        		(CalamityWorld1Point2.downedYharon ? 3 : 0);
        }
        ...
        public override void AI()
        {
			...
			if (Projectile.ai[0] < num1125 - 120f) 
			{
				for (int num1133 = 0; num1133 < 1; num1133++) 
				{
					...
					Dust dust33 = Main.dust[Dust.NewDust(position3, 0, 0, DustID.Sandnado, 0f, 0f, 0, default(Color), 0.5f)];
