        ...
        public override void AI()
        {
			...
			if (Projectile.type == Mod.Find<ModProjectile>("T1000").Type)
			{
				...
				if (Projectile.ai[1] == 1f && Projectile.ai[0] != 1f)
				{
					...
					for (int i = 0; i < 2; i++)
					{
						int num5 = Dust.NewDust(value - Vector2.One * 8f, 16, 16, DustID.RainbowTorch, Projectile.velocity.X / 2f, Projectile.velocity.Y / 2f, 100, new Color(Main.DiscoR, Main.DiscoG, Main.DiscoB), 1f);
