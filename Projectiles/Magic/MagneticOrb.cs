        ...
        public override void AI()
        {
			...
			if (flag14) 
			{
				...
				if (Projectile.localAI[0] > 4f) 
				{
					...
					num444 *= num446;
					num445 *= num446;
					Projectile.NewProjectile(Entity.GetSource_FromThis(null), vector33.X, vector33.Y, num444, num445, Mod.Find<ModProjectile>("MagneticBeam").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
					return;
				}
			}
        }
