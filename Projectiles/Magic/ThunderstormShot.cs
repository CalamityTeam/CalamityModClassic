    ...
    public class ThunderstormShot : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (Projectile.ai[0] > 9f)
			{
				for (int num121 = 0; num121 < 5; num121++)
				{
					...
					dust.noGravity = true;
					dust.noLight = true;
					Dust dust2 = Main.dust[Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 229, Projectile.velocity.X, Projectile.velocity.Y, 100, default(Color), 1f)];
        ...
        public override void OnKill(int timeLeft)
        {
			...
			for (int n = 0; n < 5; n++)
			{
				...
				num13 *= num16;
				num14 *= num16;
				Projectile.NewProjectile(Projectile.GetSource_FromThis(null), x, y, num13, num14, Mod.Find<ModProjectile>("ThunderstormShotSplit").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
			}
			...
			for (int num227 = 0; num227 < num226; num227++)
			{
				...
				int num228 = Dust.NewDust(vector6 + vector7, 0, 0, 229, vector7.X, vector7.Y, 100, default(Color), 1.2f);
			...
			for (int num227 = 0; num227 < num226; num227++)
			{
				...
				vector6 = vector6.RotatedBy((double)((float)(num227 - (num226 / 2 - 1)) * 6.28318548f / (float)num226), default(Vector2)) + Projectile.Center;
				Vector2 vector7 = vector6 - Projectile.Center;
				int num228 = Dust.NewDust(vector6 + vector7, 0, 0, 107, vector7.X, vector7.Y, 100, default(Color), 1.2f);
				Main.dust[num228].noGravity = true;
				Main.dust[num228].noLight = true;
				Main.dust[num228].velocity = vector7;
			}
