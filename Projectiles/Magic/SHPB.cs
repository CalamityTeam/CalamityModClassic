...
namespace CalamityModClassicPreTrailer.Projectiles.Magic
{
    public class SHPB : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
			...
			{
        		Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("SHPExplosion").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
            }
        }
    }
}