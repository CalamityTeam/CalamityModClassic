        ...
        public override void AI()
        {
			...
			if (flag14)
			{
				...
				if (Projectile.localAI[0] > 24f)
				{
					...
					{
						Projectile.NewProjectile(Entity.GetSource_FromThis(null), value10.X, value10.Y, num438, num439, Mod.Find<ModProjectile>("TerraBolt").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
					}
					return;
				}
			}
