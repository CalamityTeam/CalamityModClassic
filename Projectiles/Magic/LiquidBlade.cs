...
namespace CalamityModClassicPreTrailer.Projectiles.Magic
{
    public class LiquidBlade : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
    		...
    		{
    			Projectile.NewProjectile(Entity.GetSource_FromThis(null), vector2.X, vector2.Y, speedX, speedY, Mod.Find<ModProjectile>("LiquidBlade2").Type, (int)((double)Projectile.damage * 0.75f), 1f, Projectile.owner);
    		}
