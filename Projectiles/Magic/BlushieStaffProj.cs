...
namespace CalamityModClassicPreTrailer.Projectiles.Magic
{
    public class BlushieStaffProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/ExtraTextures/BlushieStaffAura").Value;
            ...
            for (int k = 0; k < count; k++)
            {
                ...
                Main.spriteBatch.Draw(texture, aura, frame, Color.White, 0f, new Vector2(0f, 32f), 1f, effects, 0f);
                aura.X += 50f;
            }
            ...
            texture = ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/ExtraTextures/BlushieStaffGear").Value;
            Vector2 origin = new Vector2(48f, 48f);
            Main.spriteBatch.Draw(texture, center, null, Color.White, Projectile.ai[0] / 20f, origin, 1.5f * scale, SpriteEffects.None, 0f);
            Main.spriteBatch.Draw(texture, topLeftGear, null, Color.White, Projectile.ai[0] / 10f, origin, scale, SpriteEffects.None, 0f);
            Main.spriteBatch.Draw(texture, topRightGear, null, Color.White, -Projectile.ai[0] / 8f, origin, 0.75f * scale, SpriteEffects.None, 0f);
            Main.spriteBatch.Draw(texture, bottomLeftGear, null, Color.White, -Projectile.ai[0] / 15f, origin, 1.4f * scale, SpriteEffects.None, 0f);
            Main.spriteBatch.Draw(texture, bottomRightGear, null, Color.White, Projectile.ai[0] / 10f, origin, scale, SpriteEffects.None, 0f);

            float seed = Projectile.localAI[0];
            texture = ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/ExtraTextures/BlushieStaffFire").Value;
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/ExtraTextures/BlushieStaffChain").Value;
