    ...
    public class TyphoonBubble : ModProjectile
    {
				...
				if (num625 < 255)
				{
					...
					if (Projectile.localAI[0] > 10f)
					{
						...
						for (int num627 = 0; num627 < num626; num627++)
						{
							...
							int num628 = Dust.NewDust(vector45 + value15, 0, 0, DustID.DungeonWater, value15.X * 2f, value15.Y * 2f, 100, default(Color), 1.4f);
        ...
        public override void OnKill(int timeLeft)
        {
			...
			for (int num227 = 0; num227 < num226; num227++)
			{
				...
				int num228 = Dust.NewDust(vector6 + vector7, 0, 0, DustID.DungeonWater, vector7.X * 2f, vector7.Y * 2f, 100, default(Color), 1.4f);
			...
			if (Projectile.owner == Main.myPlayer)
			{
				...
				{
					int num229 = Main.expertMode ? 100 : 65;
					int num230 = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X - (float)(Projectile.direction * 30), Projectile.Center.Y - 4f, (float)(-(float)Projectile.direction) * 0.01f, 0f, Mod.Find<ModProjectile>("WaterSpout").Type, num229, 4f, Projectile.owner, 16f, 15f);
