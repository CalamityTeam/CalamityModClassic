        ...
        public override void AI()
        {
			...
			if (flag14)
			{
				...
				if (Projectile.localAI[0] > 24f)
				{
					...
					num438 *= num440;
					num439 *= num440;
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), value10.X, value10.Y, num438, num439, Mod.Find<ModProjectile>("NightBolt").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
					return;
				}
			}
        }
