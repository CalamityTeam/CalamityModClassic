    ...
    public class TransfusionTrail : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			for (int num493 = 0; num493 < 1; num493++)
			{
				...
				int num496 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.VampireHeal, 0f, 0f, 100, default(Color), 0.7f);
			...
			for (int num497 = 0; num497 < 2; num497++)
			{
				...
				int num500 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.VampireHeal, 0f, 0f, 100, default(Color), 0.9f);
