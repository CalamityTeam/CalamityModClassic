...
namespace CalamityModClassic1Point2.Projectiles
{
    public class LiquidBlade : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
    		...
    		{
    			Projectile.NewProjectile(Projectile.GetSource_FromThis(), vector2.X, vector2.Y, speedX, speedY, Mod.Find<ModProjectile>("LiquidBlade2").Type, (int)((double)Projectile.damage * 0.75f), 1f, Projectile.owner);
    		}
