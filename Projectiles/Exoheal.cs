    ...
    public class Exoheal : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			for (int num497 = 0; num497 < 1; num497++)
			{
				...
				int num500 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.TerraBlade, 0f, 0f, 100, new Color(0, 255, 255), 1f);
