...
namespace CalamityModClassic1Point1.Projectiles
{
    public class IonBlast : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
        	...
        	Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("IonExplosion").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
