    ...
    public class RoyalHeal : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			for (int num493 = 0; num493 < 3; num493++)
			{
				...
				int num496 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.PurificationPowder, 0f, 0f, 100, default(Color), 1.1f);
			...
			for (int num497 = 0; num497 < 5; num497++)
			{
				...
				int num500 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.PurificationPowder, 0f, 0f, 100, default(Color), 1.3f);
