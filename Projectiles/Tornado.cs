    ...
    public class Tornado : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
			...
			Projectile.localNPCHitCooldown = 15 -
				(NPC.downedGolemBoss ? 6 : 0) -
        		(NPC.downedMoonlord ? 2 : 0) -
        		(CalamityWorld.downedDoG ? 2 : 0) -
        		(CalamityWorld.downedYharon ? 2 : 0);
        }
        ...
        public override void AI()
        {
			...
			if (Projectile.ai[0] < num1125 - 120f) 
			{
				for (int num1133 = 0; num1133 < 1; num1133++) 
				{
					...
					Dust dust33 = Main.dust[Dust.NewDust(position3, 0, 0, DustID.Flare_Blue, 0f, 0f, 0, default(Color), 0.5f)];
        ...
        public override bool PreDraw(ref Color lightColor)
        {
			...
			float num234 = 0f;
			float num235 = 5.1f;
			Microsoft.Xna.Framework.Color value34 = new Microsoft.Xna.Framework.Color(100, 225, 225);
			for (float num236 = (float)((int)value33.Y); num236 > (float)((int)value32.Y); num236 -= num235)
			{
				...
				Main.EntitySpriteDraw(texture2D23, vector34, new Microsoft.Xna.Framework.Rectangle?(rectangle9), color39, num233 + num238, origin3, 1f + num239, SpriteEffects.None, 0f);
			}
			return false;
        }
    }
