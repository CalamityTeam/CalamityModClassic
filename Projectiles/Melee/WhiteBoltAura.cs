			...
			else
			{
				...
				if (Projectile.ai[0] > 6f)
				{
					...
					if (Projectile.owner == Main.myPlayer)
					{
						...
						Projectile.NewProjectile(Projectile.GetSource_FromThis(null), (float)num414, (float)num415, 0f, 5f, Mod.Find<ModProjectile>("Whiterain").Type, Projectile.damage, 0f, Projectile.owner, 0f, 0f);
					}
				}
			}
