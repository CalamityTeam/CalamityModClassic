...
namespace CalamityModClassicPreTrailer.Projectiles.Melee
{
    public class AegisFlame : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
        	...
        	{
        		Projectile.NewProjectile(Projectile.GetSource_FromThis(null), target.Center.X, target.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("AegisBlast2").Type, (int)((double)hit.Damage * 0.75f), hit.Knockback, Main.myPlayer);
        	}
        }
