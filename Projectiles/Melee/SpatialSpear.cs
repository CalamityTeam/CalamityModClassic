        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
	            for (int i = 0; i < numProj + 1; i++)
	            {
	                ...
	                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, perturbedSpeed.X * 0.25f, perturbedSpeed.Y * 0.25f, Mod.Find<ModProjectile>("SpatialSpear2").Type, (int)((double)Projectile.damage * 0.15), Projectile.knockBack * 0.2f, Projectile.owner, 0f, 0f);
	            }
            }
        }
    }
