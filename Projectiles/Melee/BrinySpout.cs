    ...
    public class BrinySpout : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (Projectile.ai[0] == 1f && Projectile.ai[1] > 0f && Projectile.owner == Main.myPlayer)
			{
				...
				center.Y += 2f;
				int num335 = Projectile.NewProjectile(Projectile.GetSource_FromThis(null), center.X, center.Y, Projectile.velocity.X, Projectile.velocity.Y, Projectile.type, Projectile.damage, Projectile.knockBack, Projectile.owner, 10f, Projectile.ai[1] - 1f);
			}
			if (Projectile.ai[0] <= 0f)
			{
