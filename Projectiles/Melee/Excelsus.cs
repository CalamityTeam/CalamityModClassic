...
namespace CalamityModClassicPreTrailer.Projectiles.Melee
{
    public class Excelsus : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			{
				Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, (Main.rand.Next(3) == 0 ? 56 : 242), Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f);
			}
		}
		...
		public override void PostDraw(Color lightColor)
		{
			...
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/Projectiles/Melee/ExcelsusGlow").Value, Projectile.Center - Main.screenPosition, null, color, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
		}
