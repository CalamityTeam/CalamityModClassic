    ...
    public class Earth2 : ModProjectile
    {
        ...
        public override void AI()
		{
			...
			if (Main.rand.Next(16) == 0)
			{
				...
				int num59 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 229, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, 150, default(Color), 1.2f);
