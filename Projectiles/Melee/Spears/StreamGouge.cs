        ...
        public override void AI()
        {
        	...
        	if(Main.player[Projectile.owner].itemAnimation < Main.player[Projectile.owner].itemAnimationMax / 3)
        	{
				...
				if (Projectile.localAI[0] == 0f && Main.myPlayer == Projectile.owner)
				{
					...
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X * 1f, Projectile.velocity.Y * 1f, Mod.Find<ModProjectile>("EssenceBeam").Type, (int)((double)Projectile.damage * 4.0), Projectile.knockBack, Projectile.owner, 0f, 0f);
				}
        	}
        	else
        	{
