    ...
    public class Brimlance : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
    	{
        	...
        	if (target.life <= 0)
        	{
        		...
        		{
        			Projectile.NewProjectile(Projectile.GetSource_FromThis(null), target.Center.X, target.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("BrimlanceHellfireExplosion").Type, (int)((double)Projectile.damage * 0.75), hit.Knockback, Main.myPlayer);
					for (int num252 = 0; num252 < num251; num252++)
					{
						...
						Projectile.NewProjectile(Projectile.GetSource_FromThis(null), Projectile.oldPosition.X + (float)(Projectile.width / 2), Projectile.oldPosition.Y + (float)(Projectile.height / 2), value15.X, value15.Y, Mod.Find<ModProjectile>("BrimlanceStandingFire").Type, (int)((double)Projectile.damage * 0.5), 0f, Projectile.owner, 0f, 0f);
					}
        		}
        	}
		}
