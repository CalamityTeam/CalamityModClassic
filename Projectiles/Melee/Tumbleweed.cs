...
namespace CalamityModClassicPreTrailer.Projectiles.Melee
{
    public class Tumbleweed : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture2D2 = ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/ExtraTextures/Chains/TumbleweedChain").Value;
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X, Projectile.velocity.Y, Mod.Find<ModProjectile>("TumbleweedRolling").Type, Projectile.damage, Projectile.knockBack, Main.myPlayer, 0f, 0f);
            }
            Projectile.Kill();
        }
    }
