			...
			if (flag14)
			{
				...
				if (Projectile.localAI[0] > 8f)
				{
					...
					if (Main.rand.Next(2) == 0)
					{
						...
						{
							int proj = Projectile.NewProjectile(Entity.GetSource_FromThis(null), value10.X, value10.Y, num438, num439, 227, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
