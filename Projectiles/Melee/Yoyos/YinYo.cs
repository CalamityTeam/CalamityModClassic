				...
				if (Projectile.localAI[0] > 8f)
				{
					...
					if (Main.rand.Next(6) == 0)
					{
						...
						if (Projectile.owner == Main.myPlayer)
						{
							if (choice == 0)
							{
								Projectile.NewProjectile(Entity.GetSource_FromThis(null), value10.X, value10.Y, num438, num439, Mod.Find<ModProjectile>("Dark").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
							}
							else
							{
								Projectile.NewProjectile(Entity.GetSource_FromThis(null), value10.X, value10.Y, num438, num439, Mod.Find<ModProjectile>("Light").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
							}
						}
					}
				}
