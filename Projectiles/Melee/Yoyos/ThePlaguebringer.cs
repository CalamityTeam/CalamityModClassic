        ...
        public override void AI()
        {
			...
			if (flag14)
			{
				...
				if (Projectile.localAI[0] > 32f)
				{
					...
					{
						Projectile.NewProjectile(Entity.GetSource_FromThis(null), value10.X, value10.Y, num438, num439, Mod.Find<ModProjectile>("PlagueSeeker").Type, (int)((double)Projectile.damage * 0.5), Projectile.knockBack, Projectile.owner, 0f, 0f);
					}
				}
			}
        }
