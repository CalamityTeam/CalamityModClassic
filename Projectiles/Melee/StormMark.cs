...
namespace CalamityModClassicPreTrailer.Projectiles.Melee
{
    public class StormMark : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			{
				int num1137 = 100;
				Projectile.NewProjectile(Projectile.GetSource_FromThis(null), Projectile.Center, Vector2.Zero, Mod.Find<ModProjectile>("Tornado").Type, num1137, 3f, Projectile.owner, 0f, 0f);
			}
