...
namespace CalamityModClassicPreTrailer.Projectiles.Melee
{
    public class ExcelsusBlue : ModProjectile
    {
		...
		public override void PostDraw(Color lightColor)
		{
			...
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/Projectiles/Melee/ExcelsusBlueGlow").Value, Projectile.Center - Main.screenPosition, null, color, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
		}
