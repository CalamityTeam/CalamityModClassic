...
namespace CalamityModClassicPreTrailer.Projectiles.Melee
{
    public class EradicatorMeleeProjectile : ModProjectile
    {
		...
		public override void PostDraw(Color lightColor)
		{
			...
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/Projectiles/Melee/EradicatorMeleeProjectileGlow").Value, Projectile.Center - Main.screenPosition, null, Color.White, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
		}
	}
}