    ...
    public class BrinyTyphoonBubble : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                int num335 = Projectile.NewProjectile(Projectile.GetSource_FromThis(null), (float)(num331 * 16 + 8), (float)(num330 * 16 - 24), 0f, 0f, Mod.Find<ModProjectile>("BrinySpout").Type, Projectile.damage, 6f, Main.myPlayer, 16f, 25f);
