...
{
    public class ExcelsusPink : ModProjectile
    {
		...
		public override void PostDraw(Color lightColor)
		{
			...
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/Projectiles/Melee/ExcelsusPinkGlow").Value, Projectile.Center - Main.screenPosition, null, color, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
		}
