...
namespace CalamityModClassic1Point1.Projectiles
{
    public class PlagueSeeker : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Plague Seeker");
            Projectile.width = 4;
            Projectile.height = 4;
        ...
        public override void AI()
        {
			...
			if (Projectile.localAI[0] > 4f)
			{
				...
				{
					int num469 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 107, 0f, 0f, 100, default(Color), 1f);
