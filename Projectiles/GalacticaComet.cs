...
namespace CalamityModClassic1Point1.Projectiles
{
    public class GalacticaComet : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Galactica Comet");
            Projectile.width = 34;
        ...
        public override void AI()
		{
			...
			if (Main.rand.Next(16) == 0)
			{
				...
				int num59 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 64, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, 150, default(Color), 1.2f);
			...
			if (Projectile.ai[1] == 1f)
			{
				...
				{
					Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 64, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, 150, default(Color), 1.2f);
				}
