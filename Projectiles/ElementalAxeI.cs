...
namespace CalamityModClassic1Point1.Projectiles
{
    public class ElementalAxeI : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			float num635 = 0f;
			float num636 = 0f;
			if (Projectile.type == Mod.Find<ModProjectile>("ElementalAxeI").Type)
			{
				num633 = 700f;
				num634 = 800f;
				num635 = 1200f;
			...
			bool flag24 = false;
			if (Projectile.ai[0] == 2f && Projectile.type == Mod.Find<ModProjectile>("ElementalAxeI").Type)
			{
				Projectile.ai[1] += 1f;
			...
			bool flag25 = false;
			if (Projectile.ai[0] != 1f && (Projectile.type == Mod.Find<ModProjectile>("ElementalAxeI").Type))
			{
				Projectile.tileCollide = false;
			}
			...
			if (Projectile.type == Mod.Find<ModProjectile>("ElementalAxeI").Type && flag25 && Projectile.ai[0] == 0f)
			{
			...
			else
			{
				...
				if (!flag26)
				{
					flag26 = (Projectile.ai[0] == 1f && (Projectile.type == Mod.Find<ModProjectile>("ElementalAxeI").Type));
				}
				float num650 = 6f;
				if (flag26)
				{
			...
			if (Projectile.ai[1] > 0f && (Projectile.type == Mod.Find<ModProjectile>("ElementalAxeI").Type))
			{
				Projectile.ai[1] += (float)Main.rand.Next(1, 4);
			}
			if (Projectile.ai[1] > 30f && Projectile.type == Mod.Find<ModProjectile>("ElementalAxeI").Type)
			{
				Projectile.ai[1] = 0f;
				Projectile.netUpdate = true;
			}
			if (Projectile.ai[0] == 0f && (Projectile.type == Mod.Find<ModProjectile>("ElementalAxeI").Type))
			{
				if (Projectile.type == Mod.Find<ModProjectile>("ElementalAxeI").Type && Projectile.ai[1] == 0f && flag25 && num633 < 500f)
				{
					Projectile.ai[1] += 1f;
