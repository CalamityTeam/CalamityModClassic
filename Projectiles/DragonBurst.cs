...
namespace CalamityModClassic1Point1.Projectiles
{
    public class DragonBurst : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Dragon Burst");
            Projectile.width = 6;
            Projectile.height = 6;
        ...
        public override void AI()
        {
        	...
        	for (int num92 = 0; num92 < 5; num92++)
			{
				...
				int num95 = 4;
				int num96 = Dust.NewDust(new Vector2(Projectile.position.X + (float)num95, Projectile.position.Y + (float)num95), Projectile.width - num95 * 2, Projectile.height - num95 * 2, 127, 0f, 0f, 100, default(Color), 1.2f);
