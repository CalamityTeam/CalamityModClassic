...
namespace CalamityModClassic1Point2.Projectiles
{
    public class BigNuke : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
        	...
        	{
        		Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("BigNukeExplosion").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        	}
			...
			for (int num623 = 0; num623 < 210; num623++)
			{
			...
			for (int num625 = 0; num625 < 9; num625++)
			{
