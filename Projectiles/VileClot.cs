    ...
    public class VileClot : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (Projectile.localAI[0] > 4f)
			{
				...
				{
					int num469 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 14, 0f, 0f, 100, default(Color), 2f);
