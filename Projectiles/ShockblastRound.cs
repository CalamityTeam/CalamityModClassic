...
namespace CalamityModClassic1Point1.Projectiles
{
	public class ShockblastRound : ModProjectile
	{
		...
		{
			//Tooltip.SetDefault("Shockblast Round");
			Projectile.width = 8;
			Projectile.height = 8;
		...
		public override void AI()
		{
			...
			{
				Projectile.damage = (int)((double)Projectile.damage * 0.975);
				Projectile.knockBack = (float)((int)((double)Projectile.knockBack * 0.975));
			}
		}
