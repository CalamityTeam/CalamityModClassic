...
namespace CalamityModClassic1Point2.Projectiles
{
    public class SandMark : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			{
				int storm = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.Zero, Mod.Find<ModProjectile>("SandTornado").Type, Projectile.damage, 2f, Projectile.owner, 1f, 0f);
