...
namespace CalamityModClassic1Point1.Projectiles
{
    public class MagnaStrike : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Magna Strike");
            Projectile.width = 26;
        ...
        public override void AI()
        {
            ...
            {
            	Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, 160, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f);
            }
        }
