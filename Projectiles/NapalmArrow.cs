...
namespace CalamityModClassic1Point2.Projectiles
{
    public class NapalmArrow : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
			...
			{
				int num622 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Torch, 0f, 0f, 100, default(Color), 2f);
			...
			if (Projectile.owner == Main.myPlayer)
			{
				for (int num252 = 0; num252 < num251; num252++)
				{
					...
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.oldPosition.X + (float)(Projectile.width / 2), Projectile.oldPosition.Y + (float)(Projectile.height / 2), value15.X, value15.Y, Main.rand.Next(400, 403), 30, 0f, Projectile.owner, 0f, 0f);
				}
			}
        }
    }
