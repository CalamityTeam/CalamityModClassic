			...
			if (flag14)
			{
				...
				if (Projectile.localAI[0] > 8f)
				{
					...
					if (Main.rand.NextBool(2))
					{
						...
						{
							Projectile.NewProjectile(Projectile.GetSource_FromThis(), value10.X, value10.Y, num438, num439, 227, (int)((double)Projectile.damage * 0.75f), Projectile.knockBack, Projectile.owner, 0f, 0f);
						}
					}
					return;
				}
