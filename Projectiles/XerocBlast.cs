...
namespace CalamityModClassic1Point1.Projectiles
{
    public class XerocBlast : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Xeroc Blast");
            Projectile.width = 20;
        ...
        public override void AI()
        {
			...
			while ((float)num462 < num461)
			{
				...
				num463 *= num466;
				num464 *= num466;
				int num467 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 58, 0f, 0f, 100, default(Color), 1.5f);
