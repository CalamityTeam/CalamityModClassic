...
namespace CalamityModClassic1Point1.Projectiles
{
    public class TerraEdgeBeam : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
            	Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, 74, Projectile.velocity.X * 0.15f, Projectile.velocity.Y * 0.15f);
            }
        }
