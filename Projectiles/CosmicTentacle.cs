    ...
    public class CosmicTentacle : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (Projectile.scale < 1f)
			{
				...
				{
					int num898 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Enchanted_Pink, Projectile.velocity.X, Projectile.velocity.Y, 100, default(Color), 1.1f);
