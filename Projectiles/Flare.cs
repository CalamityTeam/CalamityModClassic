    ...
    public class Flare : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
			...
			if (Projectile.owner == Main.myPlayer)
			{
				...
				int num235 = Main.expertMode ? 120 : 200;
				int num236 = Projectile.NewProjectile(Projectile.GetSource_FromThis(), (float)(num232 * 16 + 8), (float)(num231 * 16 - 24), 0f, 0f, Mod.Find<ModProjectile>("Flarenado").Type, num235, 4f, Main.myPlayer, 16f, 15f);
