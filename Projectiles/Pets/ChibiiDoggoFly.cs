...
namespace CalamityModClassicPreTrailer.Projectiles.Pets
{
	public class ChibiiDoggoFly : ModProjectile
	{
		...
		public override bool PreDraw (ref Color lightColor)
		{
			...
			Texture2D texture2D3 = ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/Projectiles/Pets/ChibiiDoggoFlyMonochrome").Value;
		...
		public override bool PreAI()
		{
			...
			if (Main.player[Projectile.owner].ownedProjectileCounts[Mod.Find<ModProjectile>("ChibiiDoggoFly").Type] > 1)
			{
				Projectile.hide = true;
				Projectile.Kill();
				Main.player[Projectile.owner].ownedProjectileCounts[Mod.Find<ModProjectile>("ChibiiDoggoFly").Type]--;
				return false;
			}
		...
		{
			if (Main.player[Projectile.owner].GetModPlayer<CalamityPlayerPreTrailer>().chibii)
			...
			if (Main.projectile[byUuid].active && Main.projectile[byUuid].type == Mod.Find<ModProjectile>("ChibiiDoggo").Type)
			{
