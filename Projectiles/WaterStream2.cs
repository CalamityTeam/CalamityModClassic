...
namespace CalamityModClassic1Point1.Projectiles
{
    public class WaterStream2 : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Water Stream");
            Projectile.width = 32;
        ...
        public override void AI()
        {
			...
			for (int num151 = 0; num151 < 3; num151++)
			{
				...
				int num154 = 14;
				int num155 = Dust.NewDust(new Vector2(Projectile.position.X + (float)num154, Projectile.position.Y + (float)num154), Projectile.width - num154 * 2, Projectile.height - num154 * 2, 33, 0f, 0f, 100, default(Color), 1f);
			...
			{
				int num156 = 16;
				int num157 = Dust.NewDust(new Vector2(Projectile.position.X + (float)num156, Projectile.position.Y + (float)num156), Projectile.width - num156 * 2, Projectile.height - num156 * 2, 33, 0f, 0f, 100, default(Color), 0.5f);
