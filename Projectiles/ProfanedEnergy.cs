        ...
        public override void AI()
        {
        	...
        	if (Projectile.owner == Main.myPlayer)
			{
				...
				if (flag18)
				{
					...
					float num403 = Main.rand.Next(15, 30); //modify the speed the projectile are shot.  Lower number = slower projectile.
					...
					num404 *= num406;
					num405 *= num406;
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X - 4f, Projectile.Center.Y, num404, num405, projectileType, 118, Projectile.knockBack, Projectile.owner, 0f, 0f);
					Projectile.ai[0] = 20f;
					return;
				}
        	}
