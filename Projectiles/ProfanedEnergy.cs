    ...
    public class ProfanedEnergy : ModProjectile
    {
        ...
        public override void AI()
        {
        	...
        	if (count == 0f)
        	{
				...
				{
					int num624 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.GoldCoin, 0f, 0f, 100, default(Color), 3f);
        	...
        	if (Projectile.owner == Main.myPlayer)
			{
				...
				if (flag18)
				{
					...
					num404 *= num406;
					num405 *= num406;
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X - 4f, Projectile.Center.Y, num404, num405, projectileType, 170, Projectile.knockBack, Projectile.owner, 0f, 0f);
					Projectile.ai[0] = 8f;
					return;
				}
        	}
