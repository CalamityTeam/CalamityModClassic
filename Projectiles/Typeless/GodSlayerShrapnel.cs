...
namespace CalamityModClassicPreTrailer.Projectiles.Typeless
{
    public class GodSlayerShrapnel : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			int num199 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 173, 0f, 0f, 100, default(Color), 0.5f);
			...
			{
				int num200 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 173, 0f, 0f, 100, default(Color), 0.5f);
