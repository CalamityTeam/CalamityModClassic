...
namespace CalamityModClassicPreTrailer.Projectiles.Typeless
{
    public class GodSlayerPhantom : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int num822 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 173, 0f, 0f, 0, default(Color), 0.5f);
        ...
        {
            target.AddBuff(Mod.Find<ModBuff>("GodSlayerInferno").Type, 600);
        }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int num227 = 0; num227 < num226; num227++)
            {
                ...
                int num228 = Dust.NewDust(vector6 + vector7, 0, 0, 173, vector7.X * 1.5f, vector7.Y * 1.5f, 100, default(Color), 0.5f);
