        ...
        public override void AI()
        {
			...
			if (Main.rand.Next(12) == 0)
			{
				for (int num43 = 0; num43 < 1; num43++)
				{
					...
					int num44 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 31, 0f, 0f, 100, default(Color), 1f);
			...
			if (Main.rand.Next(64) == 0)
			{
				for (int num45 = 0; num45 < 1; num45++)
				{
					...
					int num46 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 31, 0f, 0f, 155, default(Color), 0.8f);
			...
			{
				int num154 = 14;
				int num155 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width - num154 * 2, Projectile.height - num154 * 2, 259, 0f, 0f, 100, default(Color), 1.35f);
			...
			{
				int num156 = 16;
				int num157 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width - num156 * 2, Projectile.height - num156 * 2, 259, 0f, 0f, 100, default(Color), 1f);
