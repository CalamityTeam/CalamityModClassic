    ...
    public class GhostlyBolt : ModProjectile
    {
        ...
        public override void AI()
        {
            if (Projectile.localAI[0] == 6f)
            {
                ...
                {
                    int num152 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 181, 0f, 0f, 100, default(Color), 1f);
            ...
            if (Projectile.localAI[0] > 6f)
            {
                ...
                {
                    int num154 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 181, Projectile.velocity.X * 0.2f, Projectile.velocity.Y * 0.2f, 100, default(Color), 1f);
