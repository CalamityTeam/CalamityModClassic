...
namespace CalamityModClassic1Point2.Projectiles
{
    public class Asteroid : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			Dust dust20 = Main.dust[Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.TerraBlade, 0f, 0f, 0, default(Color), 1f)];
			...
			dust20 = Main.dust[Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.TerraBlade, 0f, 0f, 0, default(Color), 1f)];
			dust20.position = position;
			dust20.velocity = Projectile.velocity.RotatedBy(-1.5707963705062866, default(Vector2)) * 0.33f + Projectile.velocity / 4f;
			dust20.position += Projectile.velocity.RotatedBy(-1.5707963705062866, default(Vector2));
			dust20.fadeIn = 0.5f;
			...
			{
				int num190 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.TerraBlade, 0f, 0f, 0, default(Color), 1f);
        ...
        public override void OnKill(int timeLeft)
        {
			...
			{
				int num338 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.TerraBlade, 0f, 0f, 100, default(Color), 2.5f);
				Main.dust[num338].noGravity = true;
				Main.dust[num338].velocity *= 3f;
				num338 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.TerraBlade, 0f, 0f, 100, default(Color), 1.5f);
