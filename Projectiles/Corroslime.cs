        ...
        public override void AI()
        {
        	if (dust == 0f)
        	{
				...
				for (int num227 = 0; num227 < num226; num227++)
				{
					...
					int num228 = Dust.NewDust(vector6 + vector7, 0, 0, DustID.Demonite, vector7.X * 1f, vector7.Y * 1f, 100, default(Color), 1.1f);
			...
			player.AddBuff(Mod.Find<ModBuff>("Corroslime").Type, 3600);
			if (flag64)
			{
				if (player.dead)
				{
