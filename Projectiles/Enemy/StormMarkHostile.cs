    ...
    public class StormMarkHostile : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (Projectile.localAI[1] == 60f && Projectile.owner == Main.myPlayer) 
			{
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(null), Projectile.Center, Vector2.Zero, Mod.Find<ModProjectile>("TornadoHostile").Type, num1137, 3f, Projectile.owner, 0f, 0f);
			}
