        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                for (int num321 = 0; num321 < num320; num321 = num3 + 1)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vector15.X, vector15.Y, Mod.Find<ModProjectile>("InkPoisonCloud").Type + Main.rand.Next(3), (int)((double)Projectile.damage * 0.66), 1f, Projectile.owner, 0f, (float)Main.rand.Next(-45, 1));
                    num3 = num321;
                }
            }
