...
namespace CalamityModClassicPreTrailer.Projectiles.SunkenSea
{
    public class AquamarineBolt : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			{
				int num154 = 14;
				int num155 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width - num154 * 2, Projectile.height - num154 * 2, 68, 0f, 0f, 100, default(Color), 1.5f);
