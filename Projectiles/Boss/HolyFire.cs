    ...
    public class HolyFire : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
        	...
        	if (randomShot == 0)
        	{
                ...
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0.01f, 0f, Mod.Find<ModProjectile>("HolyFire2").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, -0.01f, 0f, Mod.Find<ModProjectile>("HolyFire2").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
                }
        	}
        	else
        	{
                if (Projectile.owner == Main.myPlayer)
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0.05f, 0f, Mod.Find<ModProjectile>("HolyFire2").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, -0.05f, 0f, Mod.Find<ModProjectile>("HolyFire2").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
                }
        	}
        	SoundEngine.PlaySound(SoundID.Item20, Projectile.position);
