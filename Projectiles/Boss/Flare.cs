    ...
    public class Flare : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
			...
			if (Projectile.owner == Main.myPlayer)
			{
				...
				int num236 = Projectile.NewProjectile(Projectile.GetSource_FromThis(null), (float)(num232 * 16 + 8), (float)(num231 * 16 - 24), 0f, 0f, Mod.Find<ModProjectile>("Flarenado").Type, num235, 4f, Main.myPlayer, 16f, 8f + (revenge ? 2f : 0f));
