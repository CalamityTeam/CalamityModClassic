...
namespace CalamityModClassic1Point1.Projectiles
{
    public class RainbowBoom : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Rainbow Boom");
        ...
        public override void AI()
        {
			...
			while ((float)num462 < num461)
			{
				...
				num463 *= num466;
				num464 *= num466;
				int num467 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 66, 0f, 0f, 100, new Color(Main.DiscoR, Main.DiscoG, Main.DiscoB), 1.5f);
