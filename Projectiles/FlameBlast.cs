...
namespace CalamityModClassic1Point1.Projectiles
{
    public class FlameBlast : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Flame Blast");
            Projectile.width = 6;
            Projectile.height = 6;
        ...
        public override void AI()
        {
			...
			if (Projectile.localAI[0] > 4f)
			{
				...
				{
					int num469 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 244, 0f, 0f, 100, default(Color), 0.75f);
