...
namespace CalamityModClassic1Point2.Projectiles
{
    public class ElysianArrow : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
			...
			{
				int num19 = Projectile.NewProjectile(Projectile.GetSource_FromThis(), x, y, num15, num16, Mod.Find<ModProjectile>("SkyFlareFriendly").Type, 220, 9f, Projectile.owner, 0f, 0f);
