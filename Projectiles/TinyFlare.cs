...
namespace CalamityModClassic1Point0.Projectiles
{
    public class TinyFlare : ModProjectile
    {
        ...
        {
            //DisplayName.SetDefault("Tiny Flare");
            Projectile.width = 6;
            Projectile.height = 6;
        ...
        public override void AI()
        {
			...
			if (Projectile.localAI[0] > 4f)
			{
				...
				{
					int num469 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 174, 0f, 0f, 100, default(Color), 2f);
