...
namespace CalamityModClassic1Point2.Projectiles
{
    public class StormBeam : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
            	Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.Flare_Blue, Projectile.velocity.X * 0.25f, Projectile.velocity.Y * 0.25f);
            }
        }
