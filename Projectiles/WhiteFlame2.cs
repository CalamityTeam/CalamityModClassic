...
namespace CalamityModClassic1Point2.Projectiles
{
    public class WhiteFlame2 : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			{
				int num458 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.GemDiamond, 0f, 0f, 100, default(Color), 0.5f);
