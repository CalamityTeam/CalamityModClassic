...
namespace CalamityModClassic1Point1.Projectiles
{
    public class DragonDust : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Dragon Dust");
            Projectile.width = 46;
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("FlareExplosion").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
			...
			{
				int num624 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 244, 0f, 0f, 100, default(Color), 2f);
