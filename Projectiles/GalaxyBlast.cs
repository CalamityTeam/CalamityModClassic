...
namespace CalamityModClassic1Point1.Projectiles
{
    public class GalaxyBlast : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Galaxy Blast");
            Projectile.width = 10;
        ...
        public override void AI()
        {
			...
			Dust dust6 = Main.dust[Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 73, 0f, 0f, 0, default(Color), 1f)];
        ...
        public override void OnKill(int timeLeft)
        {
			...
			for (int m = 0; m < 4; m++)
			{
				Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 73, 0f, 0f, 100, default(Color), 1.5f);
			}
			for (int n = 0; n < 4; n++)
			{
				int num10 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 73, 0f, 0f, 0, default(Color), 2.5f);
				...
				num10 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 73, 0f, 0f, 100, default(Color), 1.5f);
