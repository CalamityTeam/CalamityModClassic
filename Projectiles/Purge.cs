...
namespace CalamityModClassic1Point1.Projectiles
{
    public class Purge : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (Projectile.type == Mod.Find<ModProjectile>("Purge").Type)
			{
				Projectile.ai[0] += 1f;
				int num2 = 0;
				...
				if (Projectile.ai[1] == 1f && Projectile.ai[0] != 1f)
				{
					...
					for (int i = 0; i < 2; i++)
					{
						int num5 = Dust.NewDust(value - Vector2.One * 8f, 16, 16, 107, Projectile.velocity.X / 2f, Projectile.velocity.Y / 2f, 100, default(Color), 1f);
				...
				if (flag && Main.myPlayer == Projectile.owner)
				{
					...
					if (flag2)
					{
						...
						int num6 = Mod.Find<ModProjectile>("PurgeLaser").Type;
