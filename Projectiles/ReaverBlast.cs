...
namespace CalamityModClassic1Point1.Projectiles
{
    public class ReaverBlast : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Reaver Blast");
            Projectile.width = 20;
        ...
        {
        	Lighting.AddLight(Projectile.Center, ((255 - Projectile.alpha) * 0.1f) / 255f, ((255 - Projectile.alpha) * 0.15f) / 255f, ((255 - Projectile.alpha) * 0.015f) / 255f);
			bool flag15 = false;
			bool flag16 = false;
			...
			while ((float)num462 < num461)
			{
				...
				num463 *= num466;
				num464 *= num466;
				int num467 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 74, 0f, 0f, 100, default(Color), 1.5f);
