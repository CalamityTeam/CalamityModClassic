        ...
        public override void AI()
        {
        	if (Projectile.localAI[0] == 0f)
        	{
				...
				for (int num227 = 0; num227 < num226; num227++)
				{
					...
					int num228 = Dust.NewDust(vector6 + vector7, 0, 0, 5, vector7.X * 1.5f, vector7.Y * 1.5f, 100, default(Color), 1.4f);
			...
			int num1262 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 5, 0f, 0f, 0, default(Color), 1f);
            ...
            for (int num534 = 0; num534 < 1000; num534 = num3 + 1)
            {
                if (num534 != Projectile.whoAmI && Main.projectile[num534].active && Main.projectile[num534].owner == Projectile.owner &&
                    Main.projectile[num534].type == Mod.Find<ModProjectile>("BloodClotMinion").Type &&
