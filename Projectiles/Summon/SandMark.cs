        ...
        public override void AI()
        {
			...
			if (Projectile.localAI[1] < 30f) 
			{
				for (int num1134 = 0; num1134 < 1; num1134++) 
				{
					...
					Dust dust34 = Main.dust[Dust.NewDust(position4, 0, 0, 269, 0f, 0f, 0, default(Color), 0.5f)];
			...
			{
				int storm = Projectile.NewProjectile(Projectile.GetSource_FromThis(null), Projectile.Center, Vector2.Zero, Mod.Find<ModProjectile>("SandTornado").Type, Projectile.damage, 2f, Projectile.owner, 1f, 0f);
