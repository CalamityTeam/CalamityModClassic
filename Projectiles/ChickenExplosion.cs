    ...
    public class ChickenExplosion : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			while ((float)num462 < num461)
			{
				...
				num463 *= num466;
				num464 *= num466;
				int num467 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.CopperCoin, 0f, 0f, 100, default(Color), 2.5f);
