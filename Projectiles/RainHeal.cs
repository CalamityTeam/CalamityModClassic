...
namespace CalamityModClassic1Point1.Projectiles
{
    public class RainHeal : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
			...
			{
				int num622 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 66, 0f, 0f, 100, new Color(Main.DiscoR, Main.DiscoG, Main.DiscoB), 2f);
