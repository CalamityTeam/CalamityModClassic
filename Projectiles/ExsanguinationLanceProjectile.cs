...
namespace CalamityModClassic1Point1.Projectiles
{
    public class ExsanguinationLanceProjectile : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Exsanguination Lance");
        ...
        public override void AI()
        {
        	...
        	if(Main.player[Projectile.owner].itemAnimation < Main.player[Projectile.owner].itemAnimationMax / 3)
        	{
				...
				if (Projectile.localAI[0] == 0f && Main.myPlayer == Projectile.owner)
				{
					...
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X + Projectile.velocity.X * Projectile.ai[0], Projectile.Center.Y + Projectile.velocity.Y * Projectile.ai[0], Projectile.velocity.X * 2.4f, Projectile.velocity.Y * 2.4f, Mod.Find<ModProjectile>("FlareSpear").Type, (int)((double)Projectile.damage * 0.8), Projectile.knockBack * 0.85f, Projectile.owner, 0f, 0f);
				}
        	}
        	else
        	{
