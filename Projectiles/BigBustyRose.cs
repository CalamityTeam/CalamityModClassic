...
namespace CalamityModClassic1Point2.Projectiles
{
    public class BigBustyRose : ModProjectile
    {
        ...
        {
        	bool flag64 = Projectile.type == Mod.Find<ModProjectile>("BigBustyRose").Type;
			...
			float num633 = 1000f; //700
			float num634 = 800f;
			float num635 = 1200f;
			float num636 = 300f; //150
			float num637 = 0.05f;
			for (int num638 = 0; num638 < 1000; num638++)
			{
				bool flag23 = (Main.projectile[num638].type == Mod.Find<ModProjectile>("BigBustyRose").Type);
			...
			if (Projectile.ai[0] == 0f)
			{
				...
				int num658 = Mod.Find<ModProjectile>("BrimstoneHellfireballFriendly").Type;
				if (flag25 && Projectile.ai[1] == 0f)
				{
					...
					if (Main.myPlayer == Projectile.owner && Collision.CanHitLine(Projectile.position, Projectile.width, Projectile.height, vector46, 0, 0))
					{
						...
						int num659 = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, value19.X, value19.Y, num658, (int)((float)Projectile.damage), 0f, Main.myPlayer, 1f, 0f);
