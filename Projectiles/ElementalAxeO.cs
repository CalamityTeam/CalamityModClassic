...
namespace CalamityModClassic1Point2.Projectiles
{
    public class ElementalAxeO : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
            	Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.HeatRay, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f);
            }
