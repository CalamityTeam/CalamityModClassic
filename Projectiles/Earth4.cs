    ...
    public class Earth4 : ModProjectile
    {
        ...
        public override void AI()
		{
			...
			if (Main.rand.NextBool(16))
			{
				...
				int num59 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.GreenFairy, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, 150, default(Color), 1.2f);
			...
			if (Projectile.ai[1] == 1f)
			{
				...
				{
					Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.GreenFairy, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, 150, default(Color), 1.2f);
				}
