...
namespace CalamityModClassic1Point2.Projectiles
{
    public class RoyalKnife : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
			...
			{
				int num304 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.PurificationPowder, 0f, 0f, 100, default(Color), 0.8f);
