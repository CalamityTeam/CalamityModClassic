...
namespace CalamityModClassic1Point1.Projectiles
{
    public class XerocHealOrb : ModProjectile
    {
        ...
        {
            //Tooltip.SetDefault("Xeroc Heal Orb");
            Projectile.width = 4;
            Projectile.height = 4;
        ...
        public override void AI()
        {
			...
			for (int num497 = 0; num497 < 1; num497++)
			{
				...
				int num500 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 58, 0f, 0f, 100, default(Color), 1f);
