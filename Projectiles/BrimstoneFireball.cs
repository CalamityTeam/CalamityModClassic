        	...
        	if (Projectile.wet && !Projectile.lavaWet)
        	{
        		...
        		if (Projectile.owner == Main.myPlayer)
        		{
					...
					for (int num252 = 0; num252 < num251; num252++)
					{
						...
						Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.oldPosition.X + (float)(Projectile.width / 2), Projectile.oldPosition.Y + (float)(Projectile.height / 2), value15.X, value15.Y, Mod.Find<ModProjectile>("BrimstoneHomer").Type, (int)((double)Projectile.damage * 0.85), 0f, Projectile.owner, 0f, 0f);
					}
        		}
        	}
