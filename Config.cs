...
namespace CalamityModClassicPreTrailer
{
    public static class Config
    {
        ...
        public static void Load()
        {
            ...
            {
                SetDefaults();
                CalamityModClassicPreTrailer.Instance.Logger.Error("The Calamity Mod's config file could not be found. Creating config...");
            }
            SaveConfig();
        }
        ...
        class MultiplayerSyncWorld : ModSystem
        {
