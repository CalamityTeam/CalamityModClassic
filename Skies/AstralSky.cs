...
namespace CalamityModClassicPreTrailer.Skies
{
    public class AstralSky : CustomSky
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            {
                spriteBatch.Draw(CalamityModClassicPreTrailer.AstralSky, new Rectangle(0, 0, Main.screenWidth, Main.screenHeight), Main.ColorOfTheSkies * opacity);
