...
namespace CalamityModClassicPreTrailer.World.Planets
{
    ...
    public class GrassPlanet : Planetoid
    {
        ...
        {
            (WorldGen.SavedOreTiers.Copper == TileID.Copper ? TileID.Tin : TileID.Copper),
            (WorldGen.SavedOreTiers.Iron == TileID.Iron ? TileID.Lead : TileID.Iron),
            (WorldGen.SavedOreTiers.Silver== TileID.Silver ? TileID.Tungsten : TileID.Silver),
            (WorldGen.SavedOreTiers.Gold == TileID.Gold ? TileID.Platinum : TileID.Gold)
        };
