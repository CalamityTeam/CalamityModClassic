...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureStatigel
{
	public class StatigelBed : ModTile
	{
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 64, 32, Mod.Find<ModItem>("StatigelBed").Type);
		}*/
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = Mod.Find<ModItem>("StatigelBed").Type;
		}
	}
}