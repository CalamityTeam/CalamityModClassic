...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureStatigel
{
	public class StatigelChest : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Statigel Chest";
				if (player.cursorItemIconText == "Statigel Chest")
				{
					player.cursorItemIconID = Mod.Find<ModItem>("StatigelChest").Type;
