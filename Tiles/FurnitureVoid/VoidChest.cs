...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureVoid
{
	public class VoidChest : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Void Chest";
				if (player.cursorItemIconText == "Void Chest")
				{
					player.cursorItemIconID = Mod.Find<ModItem>("VoidChest").Type;
