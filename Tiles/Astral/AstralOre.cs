...
namespace CalamityModClassicPreTrailer.Tiles.Astral
{
	public class AstralOre : ModTile
	{
		...
		{
            return CalamityWorldPreTrailer.downedStarGod;
		}
        ...
        {
            CustomTileFraming.FrameTileForCustomMerge(i, j, Type, Mod.Find<ModTile>("AstralDirt").Type, false, false, false, false, resetFrame);
            return false;
        }
    }
}