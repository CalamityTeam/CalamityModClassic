	...
	public class AshenSlab : ModTile
	{
		...
		public int GetTileVariant(int i, int j)
		{
			...
			if (j % 3 < 2)
			{
				...
				int frameX = sourceTile.TileFrameX / 18;
				int frameY = sourceTile.TileFrameY / 18;
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Texture2D glowmask = ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/Tiles/FurnitureAshen/AshenSlab_Glowmask").Value;
			spriteBatch.Draw
							 (
							 glowmask,
							 drawOffset,
