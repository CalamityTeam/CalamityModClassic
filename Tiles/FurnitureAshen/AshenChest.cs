...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureAshen
{
	public class AshenChest : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Ashen Chest";
				if (player.cursorItemIconText == "Ashen Chest")
				{
					player.cursorItemIconID = Mod.Find<ModItem>("AshenChest").Type;
