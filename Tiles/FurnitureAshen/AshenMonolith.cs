...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureAshen
{
	public class AshenMonolith : ModTile
	{
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 32, Mod.Find<ModItem>("AshenMonolith").Type);
		}*/
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			if (currentTile.TileType == Mod.Find<ModTile>("AshenMonolith").Type)
			{
				...
				Texture2D eyeSheet = ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/Tiles/FurnitureAshen/AshenMonolith_Eye").Value;
				spriteBatch.Draw
				(
					eyeSheet,
					drawOffset,
