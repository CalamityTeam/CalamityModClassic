...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureAbyss
{
	public class AbyssChest : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Abyss Chest";
				if (player.cursorItemIconText == "Abyss Chest")
				{
					player.cursorItemIconID = Mod.Find<ModItem>("AbyssChest").Type;
