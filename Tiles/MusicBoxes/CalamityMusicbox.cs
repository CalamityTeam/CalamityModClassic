...
{
	public class CalamityMusicbox : ModTile
	{
        ...
        string? source = "Source_Tile";
			...
			Item.NewItem(entity, i * 16, j * 16, 16, 48, Mod.Find<ModItem>("CalamityMusicbox").Type);
		}*/
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = Mod.Find<ModItem>("CalamityMusicbox").Type;
        }
    }
}