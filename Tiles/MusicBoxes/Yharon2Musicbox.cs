...
{
	public class Yharon2Musicbox : ModTile
	{
		...
		/*public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			Item.NewItem(entity, i * 16, j * 16, 16, 48, Mod.Find<ModItem>("Yharon2Musicbox").Type);
		}*/
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = Mod.Find<ModItem>("Yharon2Musicbox").Type;
        }
    }
}