...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureBotanic
{
	public class BotanicDoorOpen : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			TileID.Sets.CloseDoorID[Type] = Mod.Find<ModTile>("BotanicDoorClosed").Type;
        }
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, Mod.Find<ModItem>("BotanicDoor").Type);
		}*/
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = Mod.Find<ModItem>("BotanicDoor").Type;
		}
	}
}