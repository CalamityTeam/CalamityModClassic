...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureBotanic
{
	public class BotanicDoorClosed : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			TileID.Sets.OpenDoorID[Type] = Mod.Find<ModTile>("BotanicDoorOpen").Type;
        }
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, Mod.Find<ModItem>("BotanicDoor").Type);
		}*/
