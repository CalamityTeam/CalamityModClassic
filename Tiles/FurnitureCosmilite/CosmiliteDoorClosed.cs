...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureCosmilite
{
	public class CosmiliteDoorClosed : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			TileID.Sets.OpenDoorID[Type] = Mod.Find<ModTile>("CosmiliteDoorOpen").Type;
        }
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, Mod.Find<ModItem>("CosmiliteDoor").Type);
		}*/
