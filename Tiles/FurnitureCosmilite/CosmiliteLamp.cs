...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureCosmilite
{
    class CosmiliteLamp : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            // name.SetDefault("Cosmilite Lamp");
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, Mod.Find<ModItem>("CosmiliteLamp").Type);
        }
