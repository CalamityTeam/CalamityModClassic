...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureCosmilite
{
	public class CosmiliteChest : ModTile
    {
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Cosmilite Chest";
				if (player.cursorItemIconText == "Cosmilite Chest")
				{
					player.cursorItemIconID = Mod.Find<ModItem>("CosmiliteChest").Type;
