...
namespace CalamityModClassicPreTrailer.Tiles.FurniturePlaguedPlate
{
	public class PlaguedPlateChest : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Plagued Plate Chest";
				if (player.cursorItemIconText == "Plagued Plate Chest")
				{
					player.cursorItemIconID = Mod.Find<ModItem>("PlaguedPlateChest").Type;
