...
namespace CalamityModClassicPreTrailer.Tiles.FurniturePlaguedPlate
{
	public class PlaguedPlateBed : ModTile
	{
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 64, 32, Mod.Find<ModItem>("PlaguedPlateBed").Type);
		}*/
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = Mod.Find<ModItem>("PlaguedPlateBed").Type;
		}
	}
}