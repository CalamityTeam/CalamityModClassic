...
{
	public class ProfanedDoorClosed : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			TileID.Sets.OpenDoorID[Type] = Mod.Find<ModTile>("ProfanedDoorOpen").Type;
        }
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, Mod.Find<ModItem>("ProfanedDoor").Type);
		}*/
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = Mod.Find<ModItem>("ProfanedDoor").Type;
		}
	}
}