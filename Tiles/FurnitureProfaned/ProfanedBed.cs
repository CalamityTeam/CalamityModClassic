...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureProfaned
{
	public class ProfanedBed : ModTile
	{
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 64, 32, Mod.Find<ModItem>("ProfanedBed").Type);
		}*/
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = Mod.Find<ModItem>("ProfanedBed").Type;
		}
	}
}