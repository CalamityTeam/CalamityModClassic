...
{
    class ProfanedBookcase : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            // name.SetDefault("Profaned Bookcase");
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, Mod.Find<ModItem>("ProfanedBookcase").Type);
        }
    }
}
