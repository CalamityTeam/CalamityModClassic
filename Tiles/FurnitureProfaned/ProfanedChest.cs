...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureProfaned
{
	public class ProfanedChest : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Profaned Chest";
				if (player.cursorItemIconText == "Profaned Chest")
				{
					player.cursorItemIconID = Mod.Find<ModItem>("ProfanedChest").Type;
