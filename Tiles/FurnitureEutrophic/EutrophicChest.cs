...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureEutrophic
{
	public class EutrophicChest : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Eutrophic Chest";
				if (player.cursorItemIconText == "Eutrophic Chest")
				{
					player.cursorItemIconID = Mod.Find<ModItem>("EutrophicChest").Type;
