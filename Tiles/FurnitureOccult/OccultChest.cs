...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureOccult
{
	public class OccultChest : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Occult Chest";
				if (player.cursorItemIconText == "Occult Chest")
				{
					player.cursorItemIconID = Mod.Find<ModItem>("OccultChest").Type;
