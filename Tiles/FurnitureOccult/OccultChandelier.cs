...
{
    public class OccultChandelier : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            // name.SetDefault("Otherworldly Chandelier");
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 48, Mod.Find<ModItem>("OccultChandelier").Type);
        }
