...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureOccult
{
	public class OccultStone : ModTile
	{
		...
		public override void AnimateIndividualTile(int type, int i, int j, ref int frameXOffset, ref int frameYOffset)
		{
			...
			if (Main.tile[i, j - 1].TileType != Mod.Find<ModTile>("OccultStone").Type)
			{
				//Row 1 and Row 10
				if ((Main.tile[i, j - 1].TileType != Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i - 1, j - 1].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i - 1, j - 2].TileType != Mod.Find<ModTile>("OccultStone").Type) ||
				(Main.tile[i, j - 1].TileType != Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i - 1, j - 1].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i - 1, j - 2].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i - 2, j - 1].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i - 2, j - 2].TileType != Mod.Find<ModTile>("OccultStone").Type))
				{
					//Row 10
			...
			else if ((Main.tile[i - 1, j - 1].TileType != Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i + 1, j - 1].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i, j - 1].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				...
				Main.tile[i + 1, j].TileType == Mod.Find<ModTile>("OccultStone").Type))
			{
				...
				if (Main.tile[i, j - 1].TileType != Mod.Find<ModTile>("OccultStone").Type ||
					...
					Main.tile[i + 1, j].TileType == Mod.Find<ModTile>("OccultStone").Type) &&
					Main.tile[i + 1, j - 1].TileType != Mod.Find<ModTile>("OccultStone").Type &&
					Main.tile[i, j - 2].TileType == Mod.Find<ModTile>("OccultStone").Type &&
					!(Main.tile[i - 1, j - 2].TileType != Mod.Find<ModTile>("OccultStone").Type &&
					Main.tile[i - 1, j - 1].TileType == Mod.Find<ModTile>("OccultStone").Type)) ||
					((Main.tile[i - 1, j].TileType == Mod.Find<ModTile>("OccultStone").Type ||
					Main.tile[i + 1, j].TileType == Mod.Find<ModTile>("OccultStone").Type) &&
			...
			{
				//Row 3 and Row 8
				if (Main.tile[i, j - 2].TileType == Mod.Find<ModTile>("OccultStone").Type &&
					Main.tile[i + 1, j - 2].TileType == Mod.Find<ModTile>("OccultStone").Type)
				{
					//Row 3
			...
			else if ((Main.tile[i, j - 1].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i, j - 2].TileType != Mod.Find<ModTile>("OccultStone").Type) ||
			...
			frameXOffset = uniqueAnimationFrameX * 234;
		...
		public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Texture2D cloth = ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/Tiles/FurnitureOccult/OccultStone_Cloth").Value;
			//Left
			if ((Main.tile[i - 1, j].TileType != Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i, j - 1].TileType != Mod.Find<ModTile>("OccultStone").Type) ||
				(Main.tile[i, j].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i - 1, j].TileType != Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i + 1, j].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i, j - 1].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i + 1, j - 1].TileType != Mod.Find<ModTile>("OccultStone").Type))
			...
			//Bottom Left
			if ((Main.tile[i, j].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i, j - 1].TileType != Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i - 1, j].TileType != Mod.Find<ModTile>("OccultStone").Type) ||
				(Main.tile[i, j].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i + 1, j].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				...
				Main.tile[i - 1, j - 1].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i, j - 1].TileType != Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i - 2, j].TileType == Mod.Find<ModTile>("OccultStone").Type &&
				Main.tile[i - 2, j - 1].TileType == Mod.Find<ModTile>("OccultStone").Type))
			{
				//xPos must be based on the occult stone tile pos, not this tile
				int xPos = i % 3;
