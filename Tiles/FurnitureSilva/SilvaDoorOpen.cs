...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureSilva
{
	public class SilvaDoorOpen : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			TileID.Sets.CloseDoorID[Type] = Mod.Find<ModTile>("SilvaDoorClosed").Type;
        }
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, Mod.Find<ModItem>("SilvaDoor").Type);
		}*/
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = Mod.Find<ModItem>("SilvaDoor").Type;
		}
	}
}