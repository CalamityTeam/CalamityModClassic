...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureSilva
{
	public class SilvaDoorClosed : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			TileID.Sets.OpenDoorID[Type] = Mod.Find<ModTile>("SilvaDoorOpen").Type;
        }
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, Mod.Find<ModItem>("SilvaDoor").Type);
		}*/
