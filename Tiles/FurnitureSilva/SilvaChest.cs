...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureSilva
{
	public class SilvaChest : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Silva Chest";
				if (player.cursorItemIconText == "Silva Chest")
				{
					player.cursorItemIconID = Mod.Find<ModItem>("SilvaChest").Type;
