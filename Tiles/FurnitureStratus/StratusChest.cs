...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureStratus
{
	public class StratusChest : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Stratus Chest";
				if (player.cursorItemIconText == "Stratus Chest")
				{
					player.cursorItemIconID = Mod.Find<ModItem>("StratusChest").Type;
