...
namespace CalamityModClassicPreTrailer.Tiles.FurnitureStratus
{
	public class StratusDoorClosed : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			TileID.Sets.OpenDoorID[Type] = Mod.Find<ModTile>("StratusDoorOpen").Type;
        }
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, Mod.Find<ModItem>("StratusDoor").Type);
		}*/
