...
{
	public class StratusChair : ModTile
	{
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, Mod.Find<ModItem>("StratusChair").Type);
		}*/
	}
}