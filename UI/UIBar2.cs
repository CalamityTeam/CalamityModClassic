...
namespace CalamityModClassicPreTrailer.UI
{
	public class UIBar2 : UIState
	{
		...
		public static int GetTickedValue() //ditto
		{
			...
			tick = Main.player[Main.myPlayer].GetModPlayer<CalamityPlayerPreTrailer>().adrenaline;
			return tick;
		}
		...
		public override void Update(GameTime gameTime)
		{
			...
			tick = Main.player[Main.myPlayer].GetModPlayer<CalamityPlayerPreTrailer>().adrenaline; //updates the testing tick
			if (tick >= 10000)
			{
				tick = 10000;
			}
