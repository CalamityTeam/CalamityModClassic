...
namespace CalamityModClassicPreTrailer.Items.Accessories
{
    public class SummonLevelMeter : ModItem
    {
        ...
        {
            int level = Main.player[Main.myPlayer].GetModPlayer<CalamityPlayerPreTrailer>().summonLevel;
            int exactLevel = Main.player[Main.myPlayer].GetModPlayer<CalamityPlayerPreTrailer>().exactSummonLevel;
            int damageGain = 0;
            int minionKB = 0;
            int minionSlots = 0;
            switch (exactLevel)
