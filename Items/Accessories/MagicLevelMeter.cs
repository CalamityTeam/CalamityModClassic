...
namespace CalamityModClassicPreTrailer.Items.Accessories
{
    public class MagicLevelMeter : ModItem
    {
        ...
        {
            int level = Main.player[Main.myPlayer].GetModPlayer<CalamityPlayerPreTrailer>().magicLevel;
            int exactLevel = Main.player[Main.myPlayer].GetModPlayer<CalamityPlayerPreTrailer>().exactMagicLevel;
            int damageGain = 0;
            int manaUsage = 0;
            int critGain = 0;
            switch (exactLevel)
