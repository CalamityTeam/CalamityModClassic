...
namespace CalamityModClassicPreTrailer.Items.Accessories
{
    public class RangedLevelMeter : ModItem
    {
        ...
        {
            int level = Main.player[Main.myPlayer].GetModPlayer<CalamityPlayerPreTrailer>().rangedLevel;
            int exactLevel = Main.player[Main.myPlayer].GetModPlayer<CalamityPlayerPreTrailer>().exactRangedLevel;
            int damageGain = 0;
            int moveSpeed = 0;
            int critGain = 0;
            switch (exactLevel)
