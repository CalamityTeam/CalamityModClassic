...
namespace CalamityModClassicPreTrailer.Items.Accessories
{
    public class RogueLevelMeter : ModItem
    {
        ...
        {
            int level = Main.player[Main.myPlayer].GetModPlayer<CalamityPlayerPreTrailer>().rogueLevel;
            int exactLevel = Main.player[Main.myPlayer].GetModPlayer<CalamityPlayerPreTrailer>().exactRogueLevel;
            int damageGain = 0;
            int velocityGain = 0;
            int critGain = 0;
            switch (exactLevel)
