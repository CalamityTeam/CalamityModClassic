    ...
    public class Vortexpopper : ModItem
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            for (int num98 = 0; num98 < num97; num98++)
            {
                ...
                int num99 = Projectile.NewProjectile(Entity.GetSource_FromThis(null), position.X, position.Y, vector6.X, vector6.Y, 444, damage, knockback, player.whoAmI, ai, 0f);
            ...
            for (int num108 = 0; num108 < num107; num108++)
            {
                ...
                int projectile = Projectile.NewProjectile(Entity.GetSource_FromThis(null), vector2.X, vector2.Y, speedX4, speedY5, 444, damage, knockback, player.whoAmI, ai, 0f);
