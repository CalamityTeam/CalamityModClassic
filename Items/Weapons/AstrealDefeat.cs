...
namespace CalamityModClassicPreTrailer.Items.Weapons 
{
	public class AstrealDefeat : ModItem
	{
		...
		{
	        Projectile.NewProjectile(source, position.X, position.Y, velocity.X, velocity.Y, Mod.Find<ModProjectile>("AstrealArrow").Type, (int)((double)damage), knockback, player.whoAmI, 0f, 0f);
	    	return false;
		}
