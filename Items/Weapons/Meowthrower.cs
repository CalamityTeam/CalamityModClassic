...
namespace CalamityModClassic1Point1.Items.Weapons
{
	public class Meowthrower : ModItem
	{
	    ...
	    {
		    //texture =("CalamityModClassic1Point1/Items/Weapons/Meowthrower");
		    return true;
	    }
	
	    public override void SetDefaults()
	    {
		    //Tooltip.SetDefault("Meowthrower");
			Item.damage = 25;
			...
			Item.rare = 3;
			Item.autoReuse = true;
			Item.shoot = Mod.Find<ModProjectile>("MeowFire").Type; //idk why but all the guns in the vanilla source have this
