...
public class ArkoftheAncients : ModItem
{
    ...
    {
        //texture =("CalamityModClassic1Point1/Items/Weapons/ArkoftheAncients");
        return true;
    }
	...
	{
		//Tooltip.SetDefault("Ark of the Ancients");
	...
	public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
	{
		...
		int num73 = Main.rand.Next(40, 60);
		...
		for (int num108 = 0; num108 < num107; num108++)
		{
			...
			Projectile.NewProjectile(source, vector2.X, vector2.Y, speedX4, speedY5, 92, num73, num74, i, 0f, (float)Main.rand.Next(5));
		}
    	return false;
	}
