...
public class Permafrost : ModItem
{
    ...
    public override void MeleeEffects(Player player, Rectangle hitbox)
    {
    	...
    	{
			int num250 = Dust.NewDust(new Vector2((float)hitbox.X, (float)hitbox.Y), hitbox.Width, hitbox.Height, DustID.IceRod, (float)(player.direction * 2), 0f, 150, default(Color), 1.5f);
