...
public class CrimslimeStaff : ModItem
{
	...
	{
		//texture =("CalamityModClassic1Point1/Items/Weapons/4.SlimeGod/CrimslimeStaff");
		return true;
	}
	
    public override void SetDefaults()
    {
        //Tooltip.SetDefault("Crimslime Staff");
        Item.damage = 30;
        Item.mana = 10;
        Item.width = 50;
        Item.height = 50;
        ...
        Item.shootSpeed = 10f;
        Item.buffType = Mod.Find<ModBuff>("Crimslime").Type;
        Item.buffTime = 3600;
