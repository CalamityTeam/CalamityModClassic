...
namespace CalamityModClassicPreTrailer.Items.Weapons 
{
	public class CursedCapper : ModItem
	{
		...
		{
	    	Projectile.NewProjectile(source, position.X, position.Y, velocity.X, velocity.Y, Mod.Find<ModProjectile>("CursedRound").Type, damage, knockback, player.whoAmI, 0f, 0f);
	    	return false;
		}
