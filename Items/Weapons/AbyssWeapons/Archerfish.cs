...
namespace CalamityModClassicPreTrailer.Items.Weapons.AbyssWeapons
{
	public class Archerfish : ModItem
	{
        ...
        {
		    Projectile.NewProjectile(source, position.X, position.Y, velocity.X, velocity.Y, Mod.Find<ModProjectile>("Archerfish").Type, damage, knockback, player.whoAmI, 0.0f, 0.0f);
		    return false;
		}
	}
}