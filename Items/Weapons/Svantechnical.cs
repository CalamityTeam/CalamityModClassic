...
public class Svantechnical : ModItem
{
	...
	{
		//texture =("CalamityModClassic1Point1/Items/Weapons/Svantechnical");
		return true;
	}
	
    public override void SetDefaults()
    {
        //Tooltip.SetDefault("Svantechnical");
        Item.damage = 152;
        Item.DamageType = DamageClass.Ranged;
        Item.width = 60;
        Item.height = 26;
        ////Tooltip.SetDefault("Fires a string of bullets along with a shotgun blast near the mouse cursor\n70% chance to not consume ammo");
