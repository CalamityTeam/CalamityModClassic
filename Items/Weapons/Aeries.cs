...
namespace CalamityModClassicPreTrailer.Items.Weapons 
{
	public class Aeries : ModItem
	{
		...
		{
	    	Projectile.NewProjectile(source, position.X, position.Y, velocity.X, velocity.Y, Mod.Find<ModProjectile>("ShockblastRound").Type, damage, knockback, player.whoAmI, 0f, 0f);
	    	return false;
		}
