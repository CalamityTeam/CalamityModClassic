...
namespace CalamityModClassicPreTrailer.Items.Weapons.GreatSandShark
{
	public class Sandstorm : ModItem
	{
		...
		{
	    	Projectile.NewProjectile(source, position.X, position.Y, velocity.X, velocity.Y, Mod.Find<ModProjectile>("SandstormBullet").Type, damage, knockback, player.whoAmI, 0.0f, 0.0f);
	    	return false;
		}
