...
public class TheEnforcer : ModItem
{
    ...
    {
        //texture =("CalamityModClassic1Point1/Items/Weapons/TheEnforcer");
        return true;
    }

	public override void SetDefaults()
	{
		//Tooltip.SetDefault("The Enforcer");
		...
		Item.useTime = 20;
		Item.useTurn = true;
		////Tooltip.SetDefault("Striking enemies with the blade causes essence flames to appear around you\nFires a powerful essence flame burst");
	...
	public override void OnHitNPC(Player player, NPC target, NPC.HitInfo hit, int damageDone)
    {
		...
		for (int num108 = 0; num108 < num107; num108++)
		{
			...
			num78 *= num80;
			num79 *= num80;
			Projectile.NewProjectile(player.GetSource_FromThis(), vector2.X, vector2.Y, 0f, 0f, Mod.Find<ModProjectile>("EssenceFlame2").Type, num73, num74, i, 0f, (float)Main.rand.Next(3));
		}
	}
