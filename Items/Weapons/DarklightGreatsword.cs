...
public class DarklightGreatsword : ModItem
{
    ...
    {
        //texture =("CalamityModClassic1Point1/Items/Weapons/DarklightGreatsword");
        return true;
    }
	...
	{
		//Tooltip.SetDefault("Darklight Greatsword");
    ...
    {
        Projectile.NewProjectile(source, position, velocity,type, (int)((double)damage * 0.6f), knockback, player.whoAmI, 0.0f, 0.0f);
        return false;
	}
