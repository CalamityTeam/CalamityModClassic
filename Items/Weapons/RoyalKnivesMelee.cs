...
public class RoyalKnivesMelee : ModItem
{
        ...
        public override string Texture => "CalamityModClassic1Point1/Items/Weapons/RoyalKnives";
	...
	public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
    {
		...
		for (int num147 = 0; num147 < num146; num147++)
		{
			...
			float x4 = vector2.X;
			float y4 = vector2.Y;
			Projectile.NewProjectile(source, x4, y4, num148, num149, Mod.Find<ModProjectile>("RoyalKnifeMelee").Type, num73, num74, i, 0f, 0f);
		}
		return false;
	}
