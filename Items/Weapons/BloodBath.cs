...
public class BloodBath : ModItem
{
	...
	{
		//texture =("CalamityModClassic1Point1/Items/Weapons/3.Perforators/BloodBath");
		return true;
	}
	
    public override void SetDefaults()
    {
        //Tooltip.SetDefault("Blood Bath");
        Item.damage = 23;
    ...
    public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
    {
		...
		for (int num108 = 0; num108 < num107; num108++)
		{
			...
			Projectile.NewProjectile(source, vector2.X, vector2.Y, speedX4, speedY5, Mod.Find<ModProjectile>("BloodBeam").Type, num73, num74, i, 0f, (float)Main.rand.Next(15));
		}
		return false;
	}
}}