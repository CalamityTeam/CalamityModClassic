...
namespace CalamityModClassicPreTrailer.Items.Scavenger
{
	public class RavagerBag : ModItem
	{
		...
		public override void ModifyItemLoot(ItemLoot itemLoot)
		{
			...
			PreProv.OnFailedConditions(new CommonDrop(ModContent.ItemType<CoreofCinder>(), 1, 1, 4));
			PreProv.OnFailedConditions(new CommonDrop(ModContent.ItemType<CoreofEleum>(), 1, 1, 4));
			PreProv.OnFailedConditions(new CommonDrop(ModContent.ItemType<CoreofChaos>(), 1, 1, 4));
			itemLoot.Add(PreProv);
