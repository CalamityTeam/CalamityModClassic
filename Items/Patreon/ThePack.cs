...
namespace CalamityModClassicPreTrailer.Items.Patreon
{
	public class ThePack : ModItem
	{
		...
		{
			Projectile.NewProjectile(source,position.X, position.Y, velocity.X, velocity.Y, Mod.Find<ModProjectile>("ThePackMissile").Type, damage, knockback, player.whoAmI, 0.0f, 0.0f);
			return false;
		}
