...
namespace CalamityModClassicPreTrailer.Items.Patreon
{
	public class HandheldTank : ModItem
	{
		...
		{
			Projectile.NewProjectile(source, position.X, position.Y, velocity.X, velocity.Y, Mod.Find<ModProjectile>("HandheldTankShell").Type, damage, knockback, player.whoAmI, 0.0f, 0.0f);
			return false;
		}
