...
namespace CalamityModClassicPreTrailer.Items.Amidias
{
	public class Shellshooter : ModItem
	{
		...
		{
			Projectile.NewProjectile(source, position.X, position.Y, velocity.X, velocity.Y, Mod.Find<ModProjectile>("Shell").Type, damage, knockback, player.whoAmI, 0.0f, 0.0f);
			return false;
		}
	}
}