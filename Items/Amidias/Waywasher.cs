...
namespace CalamityModClassicPreTrailer.Items.Amidias
{
	public class Waywasher : ModItem
	{
		...
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
		{
			...
			Projectile.NewProjectile(source, position.X, position.Y, SpeedX, SpeedY, Mod.Find<ModProjectile>("WaywasherProj").Type, damage, knockback, player.whoAmI, 0.0f, 0.0f);
			return false;
		}
