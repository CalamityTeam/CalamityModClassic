...
{
	class Crysthamyr : ModMount
	{
		public override void SetStaticDefaults()
		{
			MountData.spawnDust = 173;
			MountData.spawnDustNoGravity = true;
			MountData.buff = Mod.Find<ModBuff>("GazeOfCrysthamyrBuff").Type;
			...
			if (Main.netMode != 2)
			{
				MountData.frontTextureExtra = ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/Items/Mounts/CrysthamyrExtra");
