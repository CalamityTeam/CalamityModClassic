...
namespace CalamityModClassic1Point1.NPCs.ShockstormShuttle
{
	public class ShockstormShuttle : ModNPC
	{
		public override void SetDefaults()
		{
			//NPC.name = "Shockstorm Shuttle");
			//Tooltip.SetDefault("Shockstorm Shuttle");
			NPC.npcSlots = 3f;
			NPC.damage = 70;
			NPC.width = 64; //324
			NPC.height = 38; //216
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("A great source of Martian Conduit Plating. With the right \"modules\", you may even be able to use them to sequence break.")
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo) //can spawn in the sky
		{
			int x = spawnInfo.SpawnTileX;
            int y = spawnInfo.SpawnTileY;
            int tile = (int)Main.tile[x, y].TileType;
            bool oUnderworld = (y <= (Main.maxTilesY * 0.1f));
            bool oRockLayer = (y >= (Main.maxTilesY * 0.001f));
            return oUnderworld && oRockLayer && Main.hardMode && !spawnInfo.PlayerInTown && Main.SceneMetrics.EvilTileCount < 80 && Main.SceneMetrics.SandTileCount < 80 && Main.SceneMetrics.JungleTileCount < 80 && Main.SceneMetrics.DungeonTileCount < 80 ? 0.035f : 0f;
		}
