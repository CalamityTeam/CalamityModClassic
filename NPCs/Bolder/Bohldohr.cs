...
namespace CalamityModClassic1Point1.NPCs.Bolder
{
	public class Bohldohr : ModNPC
	{
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("Contrary to popular belief, these lizards existed long before a certain lord.")
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
            ...
            return spawnInfo.Player.ZoneJungle && NPC.downedPlantBoss && !Main.snowMoon && !Main.pumpkinMoon ? 0.0125f : 0f; 
		}
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			for (int k = 0; k < 5; k++)
			{
				Dust.NewDust(NPC.position, NPC.width, NPC.height, 155, hit.HitDirection, -1f, 0, default(Color), 1f);
			}
			if (NPC.life <= 0)
			{
				for (int k = 0; k < 20; k++)
