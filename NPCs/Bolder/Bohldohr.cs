...
namespace CalamityModClassic1Point2.NPCs.Bolder
{
	public class Bohldohr : ModNPC
	{
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("He approaches.")
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
			...
			return SpawnCondition.JungleTemple.Chance * 0.025f;
		}
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			for (int k = 0; k < 5; k++)
			{
				Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.Ambient_DarkBrown, hit.HitDirection, -1f, 0, default(Color), 1f);
			}
			if (NPC.life <= 0)
			{
				for (int k = 0; k < 20; k++)
