...
namespace CalamityModClassic1Point1.NPCs.Cryogen
{
	...
	public class CryogenP3 : ModNPC
	{
		...
		public override void AI()
		{
			...
			Lighting.AddLight((int)((NPC.position.X + (float)(NPC.width / 2)) / 16f), (int)((NPC.position.Y + (float)(NPC.height / 2)) / 16f), 0.01f, 0.65f, 0.65f);
			...
			float num1246 = isChill ? 6.25f : 8f;
			if (num1245 < num1246)
			{
		...
		public override bool CheckDead()
		{
			...
			NPC.NewNPC(NPC.GetSource_FromThis(), (int)NPC.Center.X, (int)NPC.Center.Y - 10, Mod.Find<ModNPC>("CryogenP4").Type, 0, NPC.whoAmI, targetX, targetY);
			return true;
		}
