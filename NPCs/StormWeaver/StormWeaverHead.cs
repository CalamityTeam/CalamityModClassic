...
namespace CalamityModClassic1Point1.NPCs.StormWeaver
{
	public class StormWeaverHead : ModNPC
	{
		...
		public int maxLength = 61;
        public override void SetStaticDefaults()
        {
            NPCID.Sets.NPCBestiaryDrawModifiers value = new NPCID.Sets.NPCBestiaryDrawModifiers(0)
            {
                CustomTexturePath = "CalamityModClassic1Point1/NPCs/StormWeaver/Bestiary"
            };
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("A small cosmic serpent that eats Wyverns and Storm Swimmers.")
		...
		public override bool CheckDead()
		{
			...
			NPC.NewNPC(NPC.GetSource_FromThis(), (int)spawnAt.X, (int)spawnAt.Y, Mod.Find<ModNPC>("StormWeaverHeadNaked").Type);
			return true;
		}
