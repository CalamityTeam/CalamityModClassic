		...
		public override void AI()
		{
			...
			if (NPC.justHit)
			{
				...
				if (spawn <= 0)
				{
					...
					NPC.NewNPC(NPC.GetSource_FromThis(), (int)spawnAt.X, (int)spawnAt.Y, Mod.Find<ModNPC>("StasisProbeNaked").Type);
					NetMessage.SendData(23, -1, -1, null, Mod.Find<ModNPC>("StasisProbeNaked").Type, 0f, 0f, 0f, 0, 0, 0);
					spawn = 6;
				}
			}
