...
namespace CalamityModClassic1Point1.NPCs.CrawlerAmethyst
{
	public class CrawlerAmethyst : ModNPC
	{
		public override void SetDefaults()
		{
			//NPC.name = "Amethyst Crawler");
			//Tooltip.SetDefault("Amethyst Crawler");
			NPC.npcSlots = 0.3f;
			NPC.aiStyle = 3;
			NPC.damage = 22;
			NPC.width = 44; //324
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            return oUnderworld && oRockLayer && Main.SceneMetrics.EvilTileCount < 80 && Main.SceneMetrics.SandTileCount < 80 && Main.SceneMetrics.DungeonTileCount < 80 ? 0.035f : 0f;
        }
