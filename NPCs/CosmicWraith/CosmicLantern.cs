...
namespace CalamityModClassic1Point1.NPCs.CosmicWraith
{
	public class CosmicLantern : ModNPC
	{
		...
		{
			//NPC.name = "Cosmic Lantern");
			//Tooltip.SetDefault("Cosmic Lantern");
			NPC.npcSlots = 1f;
			NPC.aiStyle = -1;
			AIType = -1;
			NPC.damage = 100;
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("Funky lanterns.")
		...
		public override void AI()
		{
			...
			int num1262 = Dust.NewDust(NPC.position, NPC.width, NPC.height, 204, 0f, 0f, 0, default(Color), 1f);
