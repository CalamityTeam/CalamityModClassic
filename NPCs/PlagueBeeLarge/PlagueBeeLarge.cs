...
namespace CalamityModClassic1Point1.NPCs.PlagueBeeLarge
{
	public class PlagueBeeLarge : ModNPC
	{
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("A rare hornet overtaken by the plague.")

            });
        }
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            npcLoot.Add(new CommonDrop(ModContent.ItemType<PlagueCellCluster>(), 2));
        }
