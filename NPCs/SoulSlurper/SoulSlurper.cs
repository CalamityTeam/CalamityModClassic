...
namespace CalamityModClassic1Point1.NPCs.SoulSlurper
{
	public class SoulSlurper : ModNPC
	{
		public override void SetDefaults()
		{
			//NPC.name = "Soul Slurper");
			//Tooltip.SetDefault("Soul Slurper");
			NPC.npcSlots = 1f;
			NPC.damage = 65;
			NPC.width = 60; //324
			NPC.height = 40; //216
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            {
                new FlavorTextBestiaryInfoElement("A mysterious construct found roaming the Calamity Biome in swarms.")
