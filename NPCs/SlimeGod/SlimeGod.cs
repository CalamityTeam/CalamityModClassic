	...
	public class SlimeGod : ModNPC
	{
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("The Slime God's right hand slime.")
        ...
        public override void AI()
		{
			...
			if (Main.netMode != NetmodeID.MultiplayerClient)
			{
				...
				if (expertMode)
				{
					if (NPC.localAI[0] >= (float)Main.rand.Next(2100, 3500))
					{
						NPC.localAI[0] = 0f;
            ...
            else if (NPC.ai[0] == 2f)
            {
                ...
                NPC.ai[2] += 1f;
                if ((double)NPC.ai[2] > 170.0 && NPC.velocity.Y == 0f && Main.netMode != NetmodeID.MultiplayerClient)
                {
			...
			int num244 = Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.ShadowbeamStaff, NPC.velocity.X, NPC.velocity.Y, 255, new Color(0, 80, 255, 80), NPC.scale * 1.2f);
			...
			if (NPC.life <= (NPC.lifeMax * 0.5f))
			{
				...
				int spawn1 = NPC.NewNPC(NPC.GetSource_FromThis(), (int)spawnAt.X - 10, (int)spawnAt.Y, Mod.Find<ModNPC>("SlimeGodSplit").Type);
				int spawn2 = NPC.NewNPC(NPC.GetSource_FromThis(), (int)spawnAt.X + 10, (int)spawnAt.Y, Mod.Find<ModNPC>("SlimeGodSplit").Type);
				if (Main.netMode == NetmodeID.Server)
				{
					NetMessage.SendData(MessageID.SyncNPC, -1, -1, null, spawn1, 0f, 0f, 0f, 0, 0, 0);
					NetMessage.SendData(MessageID.SyncNPC, -1, -1, null, spawn2, 0f, 0f, 0f, 0, 0, 0);
				}
				NPC.life = 0;
	            NPC.active = false;
			}
		...
		{
			target.AddBuff(BuffID.ManaSickness, 200, true);
