...
namespace CalamityModClassic1Point1.NPCs.TheDevourerofGods
{
	public class DevourerofGodsTail : ModNPC
    {
		...
		{
			//NPC.name = "The Devourer of Gods Tail");
		...
		public override void OnHitPlayer(Player target, Player.HurtInfo hurtInfo)
		{
			...
			if (num == 0)
			{
				Main.NewText("Are you honestly that bad at dodging?", Color.Cyan.R, Color.Cyan.G, Color.Cyan.B);
			}
			else if (num == 1)
			{
				Main.NewText("Of all my segments to get hit by...", Color.Cyan.R, Color.Cyan.G, Color.Cyan.B);
			}
			if (Main.expertMode)
			{
