...
namespace CalamityModClassic1Point1.NPCs.DevourerSpawn
{
	public class DevourerSpawnHead : ModNPC
	{
		...
		{
			//NPC.name = "Devourer Spawn Head");
			//Tooltip.SetDefault("Devourer Spawn");
			NPC.damage = 80;
			NPC.npcSlots = 5f;
			NPC.width = 20; //324
			NPC.height = 20; //216
		...
		public override void AI()
		{
			...
			if (!TailSpawned)
            {
                ...
                for (int num36 = 0; num36 < 6; num36++)
                {
                    ...
                    if (num36 >= 0 && num36 < 5)
                    {
                        lol = NPC.NewNPC(NPC.GetSource_FromThis(), (int)NPC.position.X + (NPC.width / 2), (int)NPC.position.Y + (NPC.height / 2), Mod.Find<ModNPC>("DevourerSpawnBody").Type, NPC.whoAmI);
                    }
                    else
                    {
                        lol = NPC.NewNPC(NPC.GetSource_FromThis(), (int)NPC.position.X + (NPC.width / 2), (int)NPC.position.Y + (NPC.height / 2), Mod.Find<ModNPC>("DevourerSpawnTail").Type, NPC.whoAmI);
                    }
			...
			if (flag94)
			{
				Lighting.AddLight((int)((NPC.position.X + (float)(NPC.width / 2)) / 16f), (int)((NPC.position.Y + (float)(NPC.height / 2)) / 16f), 0.15f, 0.01f, 0.15f);
				NPC.localAI[1] = 1f;
