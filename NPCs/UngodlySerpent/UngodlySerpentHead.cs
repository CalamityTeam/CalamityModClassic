...
namespace CalamityModClassic1Point1.NPCs.UngodlySerpent
{
	public class UngodlySerpentHead : ModNPC
	{
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "CalamityModClassic1Point1/NPCs/UngodlySerpent/Bestiary"
            };
            NPCID.Sets.NPCBestiaryDrawOffset[Type] = value;
        }
        public override void SetDefaults()
		{
			//NPC.name = "UngodlySerpentHead");
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("Revenge.")
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
			...
			return (spawnInfo.Player.ZoneHallow || spawnInfo.Player.ZoneUnderworldHeight) && !Main.snowMoon && !Main.pumpkinMoon && NPC.downedMoonlord ? 0.015f : 0f;
		}
