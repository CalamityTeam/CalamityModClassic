...
{
	public class PhantomTurret : ModNPC
	{
        ...
        public override void AI()
		{
			...
			if (NPC.localAI[1] >= 240f) 
			{
				...
				if (Collision.CanHit(NPC.Center, 1, 1, player.position, player.width, player.height))
				{
					...
					if (Main.netMode != NetmodeID.MultiplayerClient)
					{
						float num418 = 14f;
						int num419 = 45;
						int num420 = Mod.Find<ModProjectile>("PhantomShot").Type;
			...
			float num1261 = revenge ? 13f : 11f;
			num1260 = num1261 / num1260;
			num1258 *= num1260;
			num1259 *= num1260;
			NPC.velocity.X = (NPC.velocity.X * 100f + num1258) / 101f;
			NPC.velocity.Y = (NPC.velocity.Y * 100f + num1259) / 101f;
			int num1262 = Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.DungeonSpirit, 0f, 0f, 0, default(Color), 1f);
