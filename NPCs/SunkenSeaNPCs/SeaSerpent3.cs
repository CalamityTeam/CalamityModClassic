...
{
	public class SeaSerpent3 : ModNPC
	{
		...
		public override void SetDefaults()
		{
            ...
            NPC.chaseable = false;
			Banner = Mod.Find<ModNPC>("SeaSerpent1").Type;
		...
		public override void AI()
		{
            ...
            if (!NPC.AnyNPCs(Mod.Find<ModNPC>("SeaSerpent1").Type))
            {
                NPC.active = false;
            }
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
            ...
            if (NPC.life <= 0)
            {
                ...
                if (Main.netMode != NetmodeID.Server)
				    Gore.NewGore(NPC.GetSource_FromThis(null), NPC.position, NPC.velocity, Mod.Find<ModGore>("SeaSerpentGore3").Type, 1f);
            }
        }
	}
}