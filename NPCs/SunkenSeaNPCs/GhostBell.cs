...
namespace CalamityModClassicPreTrailer.NPCs.SunkenSeaNPCs
{
	public class GhostBell : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			Banner = NPC.type;
			BannerItem = Mod.Find<ModItem>("GhostBellBanner").Type;
		...
		public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
		{
			...
			vector -= new Vector2((float)ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/NPCs/SunkenSeaNPCs/GhostBellGlow").Value.Width, (float)(ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/NPCs/SunkenSeaNPCs/GhostBellGlow").Value.Height / Main.npcFrameCount[NPC.type])) * 1f / 2f;
			...
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalamityModClassicPreTrailer/NPCs/SunkenSeaNPCs/GhostBellGlow").Value, vector,
