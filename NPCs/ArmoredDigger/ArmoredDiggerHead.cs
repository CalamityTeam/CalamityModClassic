...
namespace CalamityModClassic1Point1.NPCs.ArmoredDigger
{
	public class ArmoredDiggerHead : ModNPC
	{
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "CalamityModClassic1Point1/NPCs/ArmoredDigger/Bestiary"
            };
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            return oUnderworld && oRockLayer && NPC.downedPlantBoss && Main.SceneMetrics.EvilTileCount < 80 && Main.SceneMetrics.SandTileCount < 80 && Main.SceneMetrics.JungleTileCount < 80 && Main.SceneMetrics.DungeonTileCount < 80 ? 0.01f : 0f;
        }
        ...
        {
			npcLoot.Add(new CommonDrop(ModContent.ItemType<Ectoblood>(), 2, 3, 5));
        }
	}
}