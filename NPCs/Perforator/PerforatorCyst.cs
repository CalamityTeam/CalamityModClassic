	...
	public class PerforatorCyst : ModNPC
	{
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("Violence.")
		...
		{
			if (spawnInfo.PlayerSafe || !NPC.downedBoss2 || NPC.AnyNPCs(Mod.Find<ModNPC>("PerforatorCyst").Type) || NPC.AnyNPCs(Mod.Find<ModNPC>("PerforatorHive").Type))
			{
				return 0f;
			}
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			...
			if (NPC.life <= 0)
			{
				...
				NPC.NewNPC(NPC.GetSource_FromThis(), (int)spawnAt.X, (int)spawnAt.Y, Mod.Find<ModNPC>("PerforatorHive").Type);
			}
		}
	}
}