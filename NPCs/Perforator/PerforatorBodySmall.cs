...
namespace CalamityModClassicPreTrailer.NPCs.Perforator
{
	public class PerforatorBodySmall : ModNPC
	{
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			...
			if (NPC.life <= 0)
			{
				...
				if (Main.netMode != NetmodeID.Server)
					Gore.NewGore(NPC.GetSource_FromThis(null), NPC.position, NPC.velocity, Mod.Find<ModGore>("SmallPerf2").Type, 1f);
            }
		}
        ...
        {
            target.AddBuff(Mod.Find<ModBuff>("BurningBlood").Type, 90, true);
