...
namespace CalamityModClassic1Point1.NPCs.Perforator
{
	...
	public class PerforatorHeadSmall : ModNPC
	{
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "CalamityModClassic1Point1/NPCs/Perforator/Bestiary_Small"
            };
            NPCID.Sets.NPCBestiaryDrawOffset[Type] = value;
        }
        public override void SetDefaults()
		{
			//NPC.name = "PerforatorHeadSmall");
        ...
        {
            npcLoot.Add(ItemDropRule.ByCondition(new Conditions.NotExpert(), ModContent.ItemType<BloodSample>(), 1, 3, 5));
            npcLoot.Add(ItemDropRule.ByCondition(new Conditions.NotExpert(), ItemID.Vertebrae, 1, 1, 4));
            npcLoot.Add(ItemDropRule.ByCondition(new Conditions.NotExpert(), ItemID.CrimtaneBar, 1));
        }
