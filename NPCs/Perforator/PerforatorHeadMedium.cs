	...
	public class PerforatorHeadMedium : ModNPC
	{
		...
		public override void SetStaticDefaults()
        {
            NPCID.Sets.NPCBestiaryDrawModifiers value = new NPCID.Sets.NPCBestiaryDrawModifiers(0)
            {
                Scale = 0.8f,
                PortraitScale = 0.8f,
                CustomTexturePath = "CalamityModClassic1Point2/NPCs/Perforator/Bestiary_Medium",
        ...
        public override void AI()
		{
			...
			if (!TailSpawned)
            {
                ...
                for (int num36 = 0; num36 < 21; num36++)
                {
                    int lol = 0;
                    if (num36 >= 0 && num36 < 20)
                    {
        ...
        {
            npcLoot.Add(new CommonDrop(ModContent.ItemType<BloodSample>(), 1, 3, 7));
            npcLoot.Add(new CommonDrop(ItemID.Vertebrae, 1, 2, 4));
            npcLoot.Add(new CommonDrop(ItemID.CrimtaneBar, 1, 2, 3));
        }
