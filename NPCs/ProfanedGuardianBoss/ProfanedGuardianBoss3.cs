...
namespace CalamityModClassic1Point1.NPCs.ProfanedGuardianBoss
{
	public class ProfanedGuardianBoss3 : ModNPC
	{
		public override void SetDefaults()
		{
			//NPC.name = "Profaned Guardian");
			//Tooltip.SetDefault("Profaned Guardian");
			NPC.npcSlots = 10f;
			NPC.aiStyle = -1;
			NPC.damage = 130;
			NPC.width = 100; //324
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("The most uhh, healive? of the Profaned Guardians.")
		...
		public override void AI()
		{
			...
			if (CalamityGlobalNPC1Point1.doughnutBoss < 0) 
			{
				NPC.active = false;
				NPC.netUpdate = true;
				return;
			...
			if (NPC.ai[0] == 0f) 
			{
				...
				float num784 = Main.npc[CalamityGlobalNPC1Point1.doughnutBoss].Center.X - vector96.X;
				float num785 = Main.npc[CalamityGlobalNPC1Point1.doughnutBoss].Center.Y - vector96.Y;
			...
			else 
			{
				...
				float num787 = Main.npc[CalamityGlobalNPC1Point1.doughnutBoss].Center.X - vector97.X;
				float num788 = Main.npc[CalamityGlobalNPC1Point1.doughnutBoss].Center.Y - vector97.Y;
