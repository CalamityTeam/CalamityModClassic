...
namespace CalamityModClassic1Point2.NPCs.StasisProbe
{
	public class StasisProbe : ModNPC
	{
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("Soon to be exclusively used by weaker cosmic worms.")
        ...
        public override void AI()
		{
			...
			NPC.localAI[0] += 1f;
			if (Main.netMode != NetmodeID.MultiplayerClient && NPC.localAI[0] >= 60f)
			{
				NPC.localAI[0] = 0f;
