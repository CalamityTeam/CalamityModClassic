...
namespace CalamityModClassic1Point1.NPCs.StasisProbe
{
	public class StasisProbe : ModNPC
	{
		public override void SetDefaults()
		{
			...
			//Tooltip.SetDefault("Stasis Probe");
			NPC.npcSlots = 1f;
			NPC.damage = 35;
			NPC.width = 30; //324
			NPC.height = 30; //216
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("A probe detatched from a cosmic serpent. They fire freezing lasers that stunlock targets.")
