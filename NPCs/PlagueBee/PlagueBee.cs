...
namespace CalamityModClassic1Point2.NPCs.PlagueBee
{
	public class PlagueBee : ModNPC
	{
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("A plague hornet.")
        ...
        {
            npcLoot.Add(new CommonDrop(ModContent.ItemType<PlagueCellCluster>(), 1, 1, 2));
        }
