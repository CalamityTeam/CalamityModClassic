	...
	public class SupremeCatastrophe : ModNPC
	{
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("What a Catastrophe.")
					...
					if (Collision.CanHit(NPC.position, NPC.width, NPC.height, Main.player[NPC.target].position, Main.player[NPC.target].width, Main.player[NPC.target].height))
					{
						...
						if (Main.netMode != 1)
						{
							...
							if (NPC.localAI[1] > 50f)
							{
								...
								int projChoice = Mod.Find<ModProjectile>("BrimstoneBall2").Type;
								...
								Projectile.NewProjectile(NPC.GetSource_FromThis(), vector86.X, vector86.Y, num864, num865, projChoice, num868, 0f, Main.myPlayer, 0f, 0f);
								return;
							}
						}
					}
