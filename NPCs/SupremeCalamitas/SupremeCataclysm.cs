	...
	public class SupremeCataclysm : ModNPC
	{
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
			{
				...
				new FlavorTextBestiaryInfoElement("The Witch's revived brother, Cataclysm. He is a shell of his former self however.")
			});
		}
        ...
        public override void AI()
		{
			...
			if (NPC.localAI[0] >= 120f)
			{
				...
				if (NPC.ai[1] >= 60f)
				{
					...
					int num691 = Mod.Find<ModProjectile>("BrimstoneWave").Type;
					if (Main.netMode != 1)
					{
				...
				NPC.ai[2] += 1f;
				if (!NPC.AnyNPCs(Mod.Find<ModNPC>("SupremeCatastrophe").Type))
				{
					NPC.ai[2] += 2f;
				}
				if (NPC.ai[2] >= 300f)
