...
namespace CalamityModClassic1Point1.NPCs.Leviathan
{
	public class AquaticAberration : ModNPC
	{
		...
		{
			//NPC.name = "Aquatic Aberration");
			//Tooltip.SetDefault("Aquatic Aberration");
			NPC.npcSlots = 1f;
			NPC.aiStyle = -1;
			NPC.damage = 80;
			NPC.width = 70; //324
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("Smaller creatures often flock around larger ones in hopes of gathering free leftovers.")
		...
		public override void AI()
		{
			...
			if (NPC.ai[0] == 3f) 
			{
				...
				{
					int num1018 = Dust.NewDust(NPC.position, NPC.width, NPC.height, 33, 0f, 0f, 100, default(Color), 1.5f);
				...
				{
					int num1020 = Dust.NewDust(NPC.position, NPC.width, NPC.height, 33, 0f, 0f, 100, default(Color), 0.5f);
					...
					{
						num1020 = Dust.NewDust(NPC.position, NPC.width, NPC.height, 33, 0f, 0f, 100, default(Color), 0.9f);
						Main.dust[num1020].noGravity = true;
					...
					{
						num1020 = Dust.NewDust(NPC.position, NPC.width, NPC.height, 33, 0f, 0f, 100, default(Color), 0.7f);
						Main.dust[num1020].velocity *= 1.2f;
						Main.dust[num1020].position = ((float)Main.rand.NextDouble() * 6.28318548f).ToRotationVector2() * ((float)Main.rand.NextDouble() * 96f) + NPC.Center;
						Main.dust[num1020].velocity = Main.dust[num1020].velocity / 2f + Vector2.Normalize(Main.dust[num1020].position - NPC.Center);
					}
