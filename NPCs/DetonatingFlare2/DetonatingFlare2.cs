...
namespace CalamityModClassic1Point1.NPCs.DetonatingFlare2
{
	public class DetonatingFlare2 : ModNPC
	{
		public override void SetDefaults()
		{
			//NPC.name = "Detonating Flame");
			//Tooltip.SetDefault("Detonating Flame");
			NPC.npcSlots = 0.5f;
			NPC.damage = 200;
			NPC.width = 35; //324
			NPC.height = 70; //216
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("Living fire, but it shoots more fire.")
        ...
        public override void AI()
		{
			...
			int num1262 = Dust.NewDust(NPC.position, NPC.width, NPC.height, 244, 0f, 0f, 0, default(Color), 1f);
