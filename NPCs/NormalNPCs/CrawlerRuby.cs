	...
	public class CrawlerRuby : ModNPC
	{
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
			{
				...
				new FlavorTextBestiaryInfoElement("A scaredy lizard from the underground covered in Rubies, when threatened it will do its best to run away! poor thing.")
			});
		}
		...
		public override void SetDefaults()
		{
			...
			Banner = NPC.type;
			BannerItem = Mod.Find<ModItem>("RubyCrawlerBanner").Type;
		}
		...
		{
			npcLoot.Add(new CommonDrop(ItemID.Ruby, 1, 2, 5));
		}
	}
}