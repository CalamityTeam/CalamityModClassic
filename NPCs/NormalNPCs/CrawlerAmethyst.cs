	...
	public class CrawlerAmethyst : ModNPC
	{
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
			{
				...
				new FlavorTextBestiaryInfoElement("A scaredy lizard from the underground covered in Amethyst, when threatened it will do its best to run away! poor thing.")
			});
		}
		...
		public override void SetDefaults()
		{
			...
			Banner = NPC.type;
			BannerItem = Mod.Find<ModItem>("AmethystCrawlerBanner").Type;
		}
		...
		{
			npcLoot.Add(new CommonDrop(ItemID.Amethyst, 1, 2, 5));
		}
	}
}