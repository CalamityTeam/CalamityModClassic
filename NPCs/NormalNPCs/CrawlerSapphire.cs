	...
	public class CrawlerSapphire : ModNPC
	{
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
			{
				...
				new FlavorTextBestiaryInfoElement("A scaredy lizard from the underground covered in Sapphires, when threatened it will do its best to run away! poor thing.")
			});
		}
		...
		public override void SetDefaults()
		{
			...
			Banner = NPC.type;
			BannerItem = Mod.Find<ModItem>("SapphireCrawlerBanner").Type;
		}
		...
		{
			npcLoot.Add(new CommonDrop(ItemID.Sapphire, 1, 2, 5));
		}
	}
}