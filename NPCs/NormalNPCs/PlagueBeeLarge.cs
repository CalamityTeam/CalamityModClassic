	...
	public class PlagueBeeLarge : ModNPC
	{
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
			{
				...
				new FlavorTextBestiaryInfoElement("A large bee overtaken by plague nanomachines, it now serves the plague completely.")
			});
		}
		...
		public override void SetDefaults()
		{
			...
			Banner = Mod.Find<ModNPC>("PlagueBee").Type;
			BannerItem = Mod.Find<ModItem>("PlagueChargerBanner").Type;
		}
		
		public override void ModifyNPCLoot(NPCLoot npcLoot)
		{
			npcLoot.Add(new CommonDrop(Mod.Find<ModItem>("PlagueCellCluster").Type, 1, 2, 4));
		}
