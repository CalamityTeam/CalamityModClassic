...
namespace CalamityModClassicPreTrailer.NPCs.NormalNPCs
{
	public class IceClasper : ModNPC
	{
		...
		public override void SetDefaults()
		{
            ...
            NPC.rarity = 2;
			Banner = NPC.type;
			BannerItem = Mod.Find<ModItem>("IceClasperBanner").Type;
		}
        ...
        public override void AI()
        {
            ...
            if (Main.netMode != 1 && NPC.localAI[0] >= 150f)
            {
                ...
                if (Collision.CanHit(NPC.position, NPC.width, NPC.height, Main.player[NPC.target].position, Main.player[NPC.target].width, Main.player[NPC.target].height))
                {
                    ...
                    int num9 = 128;
                    int beam = Projectile.NewProjectile(Entity.GetSource_FromThis(null), vector.X, vector.Y, num4, num5, num9, num8, 0f, Main.myPlayer, 0f, 0f);
        ...
        {
            npcLoot.Add(new CommonDrop(Mod.Find<ModItem>("EssenceofEleum").Type, 1));
            npcLoot.Add(new CommonDrop(Mod.Find<ModItem>("FrostBarrier").Type, 10));
            npcLoot.Add(new CommonDrop(Mod.Find<ModItem>("AncientIceChunk").Type, 3));
        }
	}
}