	...
	public class CrawlerEmerald : ModNPC
	{
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
			{
				...
				new FlavorTextBestiaryInfoElement("A scaredy lizard from the underground covered in Emeralds, when threatened it will do its best to run away! poor thing.")
			});
		}
		...
		public override void SetDefaults()
		{
			...
			Banner = NPC.type;
			BannerItem = Mod.Find<ModItem>("EmeraldCrawlerBanner").Type;
		}
		...
		{
			npcLoot.Add(new CommonDrop(ItemID.Emerald, 1, 2, 5));
		}
	}
}