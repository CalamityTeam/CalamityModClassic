	...
	public class CrawlerTopaz : ModNPC
	{
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
			{
				...
				new FlavorTextBestiaryInfoElement("A scaredy lizard from the underground covered in Topazes, when threatened it will do its best to run away! poor thing.")
			});
		}
		...
		public override void SetDefaults()
		{
			...
			Banner = NPC.type;
			BannerItem = Mod.Find<ModItem>("TopazCrawlerBanner").Type;
		}
		...
		{
			npcLoot.Add(new CommonDrop(ItemID.Topaz, 1, 2, 5));
		}
	}
}