...
namespace CalamityModClassic1Point2.NPCs.Calamitas
{
	...
	public class CalamitasRun2 : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			AnimationType = 126;
			NPC.alpha = 50;
			NPC.lifeMax = CalamityWorld1Point2.revenge ? 4400 : 3000;
			NPC.aiStyle = -1; //new
            AIType = -1; //new
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("A replica, or clone, or something like that of the Supreme Swordsman, Catastrophe.")
        ...
        {
            npcLoot.Add(new CommonDrop(ModContent.ItemType<CatastropheTrophy>(), 10));
            npcLoot.Add(ItemDropRule.NormalvsExpert(ModContent.ItemType<CrushsawCrasher>(), 4, 10));
        }
