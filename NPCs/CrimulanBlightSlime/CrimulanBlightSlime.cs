...
namespace CalamityModClassic1Point1.NPCs.CrimulanBlightSlime
{
	public class CrimulanBlightSlime : ModNPC
	{
		public override void SetDefaults()
		{
			//NPC.name = "Crimulan Blight Slime");
			//Tooltip.SetDefault("Crimulan Blight Slime");
			NPC.aiStyle = 1;
			NPC.damage = 65;
			NPC.width = 60; //324
			NPC.height = 42; //216
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement("A large crimson slime that drops purple gel.")
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
            ...
            return spawnInfo.Player.ZoneCrimson && NPC.downedBoss3 && !Main.snowMoon && !Main.pumpkinMoon ? 0.1f : 0f; 
		}
